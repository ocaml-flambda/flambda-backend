...
let nullary_prim_size prim =
  ...
  | Begin_region { definitely_unused = true } -> 0
  | Begin_region { definitely_unused = false } -> 1
...
let unary_prim_size prim =
  ...
  | Begin_try_region { definitely_unused = true } -> 0
  | Begin_try_region { definitely_unused = false } -> 1
  | End_region { definitely_unused = true } -> 0
  | End_region { definitely_unused = false } -> 1
