...
module Acc : sig
  ...
  (* Executes [f] in an acc with an empty cost metrics and returns
     the cost metrics for the term generated by f separately from the one
     in the acc *)
  val measure_cost_metrics
     : t
    -> f:(t -> t * 'a)
    -> Flambda.Cost_metrics.t * t * 'a
end
