...
type t =
  ...
  (* CR mshinwell: Add constructors for the following too so we can check they
     aren't bottom? *)
  | Boxed_float of T.t
  | Boxed_int32 of T.t
  | Boxed_int64 of T.t
...
let apply_renaming t perm =
  match t with
  | Variant { blocks; immediates; is_unique } -> begin
...
let meet_variant env ~blocks1 ~imms1 ~blocks2 ~imms2 : _ Or_bottom.t =
  let blocks =
...
let join_variant env ~blocks1 ~imms1 ~blocks2 ~imms2 : _ Or_unknown.t =
