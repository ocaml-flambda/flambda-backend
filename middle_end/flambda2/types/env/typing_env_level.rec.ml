...
(* let defines_name_but_no_equations t name = match Name.to_var name with | None
  ...
  ListLabels.fold_left envs_with_levels
    ...
    ~f:(fun (joined_types, defined_variables) (env_at_use, _, _, t) ->
        ...
        | Some var -> (
          let joined_ty =
            ...
            | Some joined_ty, None ->
              ...
              let is_defined_at_use = Variable.Map.mem var t.defined_vars in
      ...
      let defined_variables =
        Variable.Set.union defined_variables (Variable.Map.keys t.defined_vars)
      in
