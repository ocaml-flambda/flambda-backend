...
(* WARNING: sys.ml is generated from sys.mlp. DO NOT EDIT sys.ml or your changes
   will be lost. *)
...
let getenv_opt s =
  ...
  try Some (getenv s) with Not_found -> None
...
let catch_break on =
  if on
  then set_signal sigint (Signal_handle (fun _ -> raise Break))
  else set_signal sigint Signal_default
