    ...
    module Operation :
      ...
      struct
        ...
        let offset_in_bytes ~arg_offset_in_bytes (t1 : t) (t2 : t) =
          __dummy2__ ()[@@inline never ][@@local never ]
        ...
        let is_adjacent reaching_definitions =
          ...
          match offset_in_bytes ~arg_offset_in_bytes (__dummy2__ ())
                  (__dummy2__ ())
          with
          | None -> __dummy2__ ()
          | Some offset_in_bytes -> __dummy2__ ()[@@inline never ][@@local never
                                                                    ]
        let is_before ~arg_offset_in_bytes t1 t2 block =
          let res =
            ...
            with
            | None -> __dummy2__ ()
            | Some offset_in_bytes -> __dummy2__ () in
          __dummy2__ ()
        ...
        let is_disjoint reaching_definitions =
          let arg_offset_in_bytes r1 r2 = __dummy2__ ()[@@inline never ]
            [@@local never ] in
          ...
          __ignore__
            ((__dummy2__ ())
               (fun block ->
                  ...
                  let deps = (__dummy2__ ()) deps in __dummy2__ ()));
          __dummy2__ ());
  __dummy2__ ()[@@inline never][@@local never]