...
let test_recursive_meet () =
  ...
  let nb_y = Name_in_binding_pos.create n_y Name_mode.normal in
  let nb_z = Name_in_binding_pos.create n_z Name_mode.normal in
  let nb_v = Name_in_binding_pos.create n_v Name_mode.normal in
