...
let simplify_read_offset dacc ~original_term _dbg ~arg1:_ ~arg1_ty:_ ~arg2:_ ~arg2_ty:_
    ~result_var =
  SPR.create_unit dacc ~result_var ~original_term
...
let simplify_binary_primitive0 dacc original_prim (prim : P.binary_primitive)
  ...
  let simplifier =
    ...
    | Read_offset _ -> simplify_read_offset
  in
...
let recover_comparison_primitive dacc (prim : P.binary_primitive) ~arg1 ~arg2 =
  ...
  | Atomic_set _ | Atomic_int_arith _ | Poke _ | Read_offset _ ->
    None
