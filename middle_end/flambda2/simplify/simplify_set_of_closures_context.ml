            ...
            (fun function_slot old_code_id ->
              ...
              let new_code_id =
                ...
                if Code_or_metadata.code_present code_or_metadata &&
                   not (Code_metadata.stub (Code_or_metadata.code_metadata code_or_metadata)) then
    ...
    (fun old_to_new_code_ids_all_sets set_of_closures ->
      ...
      Function_slot.Map.fold
        (fun _ old_code_id old_to_new_code_ids ->
           ...
           in
           if Code_or_metadata.code_present code && not (Code_metadata.stub (Code_or_metadata.code_metadata code)) then
