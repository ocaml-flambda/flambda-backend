...
let enter_closure code_id ~return_continuation ~exn_continuation ~self_continuation ~my_closure t =
  { t with
    closure_info =
      Closure_info.in_a_closure code_id ~return_continuation ~exn_continuation ~self_continuation ~my_closure
  }
