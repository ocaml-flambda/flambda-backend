...
let simplify_begin_try_region ~definitely_unused:_ dacc ~original_term ~arg:_
    ~arg_ty:_ ~result_var =
  SPR.create_unknown dacc ~result_var K.region ~original_term

let simplify_end_region ~definitely_unused:_ dacc ~original_term ~arg:_
    ~arg_ty:_ ~result_var =
...
let simplify_unary_primitive dacc original_prim (prim : P.unary_primitive) ~arg
  ...
  let simplifier =
    ...
    | Begin_try_region { definitely_unused } ->
      simplify_begin_try_region ~definitely_unused
    | End_region { definitely_unused } -> simplify_end_region ~definitely_unused
