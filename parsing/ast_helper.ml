...
module Pat = struct
  ...
  let record_flat ?loc ?attrs a b = mk ?loc ?attrs (Ppat_record_flat (a, b))
...
module Exp = struct
  ...
  let field_flat ?loc ?attrs a b = mk ?loc ?attrs (Pexp_field_flat (a, b))
  let setfield ?loc ?attrs a b c = mk ?loc ?attrs (Pexp_setfield (a, b, c))
  let setfield_flat ?loc ?attrs a b c = mk ?loc ?attrs (Pexp_setfield_flat (a, b, c))
