...
Error: Signature mismatch:
       ...
       is not included in
         type t = int * string
       The type t = A.t is not equal to the type int * string
|}]
...
Error: Signature mismatch:
       ...
       is not included in
         type 'a t = 'a
       The type 'a t = 'a B.t is not equal to the type 'a
|}];;
...
Error: Signature mismatch:
       ...
       is not included in
         type 'a t = int
       The type 'a t = 'a D.t is not equal to the type int
|}];;
...
Error: Signature mismatch:
       ...
       is not included in
         type 'a t = [ `Foo ]
       The type 'a t = 'a E2.t is not equal to the type [ `Foo ]
|}];;
