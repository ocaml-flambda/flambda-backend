...
(* flambda: the -lambda output differs slightly with flambda, and
...
(* All of the below functions themselves are locally allocated.
   Each function below corresponds to a function in the top half of this file.
 *)
