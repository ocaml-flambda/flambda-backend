...
type t3 = { mutable float_u0 : float#; mutable float1 : float; mutable float_u2 : float# }
type t4 = { mutable float0 : float; mutable float1 : float; mutable float_u2 : float# }
type t5 = { mutable float_u0 : float#; mutable float_u1 : float#; mutable float2 : float }
type t6 = { mutable float0 : float; mutable float_u1 : float#; mutable float2 : float }
type t7 = { mutable float_u0 : float#; mutable float1 : float; mutable float2 : float }
type t8 = { mutable float0 : float; mutable float_u1 : float#; mutable float_u2 : float#; mutable float_u3 : float# }
type t9 = { mutable float_u0 : float#; mutable float1 : float; mutable float_u2 : float#; mutable float_u3 : float# }
type t10 = { mutable float0 : float; mutable float1 : float; mutable float_u2 : float#; mutable float_u3 : float# }
type t11 = { mutable float_u0 : float#; mutable float_u1 : float#; mutable float2 : float; mutable float_u3 : float# }
type t12 = { mutable float0 : float; mutable float_u1 : float#; mutable float2 : float; mutable float_u3 : float# }
type t13 = { mutable float_u0 : float#; mutable float1 : float; mutable float2 : float; mutable float_u3 : float# }
type t14 = { mutable float0 : float; mutable float1 : float; mutable float2 : float; mutable float_u3 : float# }
type t15 = { mutable float_u0 : float#; mutable float_u1 : float#; mutable float_u2 : float#; mutable float3 : float }
type t16 = { mutable float0 : float; mutable float_u1 : float#; mutable float_u2 : float#; mutable float3 : float }
type t17 = { mutable float_u0 : float#; mutable float1 : float; mutable float_u2 : float#; mutable float3 : float }
type t18 = { mutable str0 : string; mutable float_u1 : float# }
type t19 = { mutable float32_u0 : float32# }
type t20 = { mutable str0 : string; mutable float32_u1 : float32# }
type t21 = { mutable i32_0 : int32# }
type t22 = { mutable str0 : string; mutable str1 : string; mutable float_u2 : float# }
type t23 = { mutable float0 : float; mutable float32_u1 : float32# }
type t24 = { mutable str0 : string; mutable i32_1 : int32# }
type t25 = { mutable i64_0 : int64# }
type t26 = { mutable float0 : float; mutable str1 : string; mutable float_u2 : float# }
type t27 = { mutable str0 : string; mutable str1 : string; mutable float32_u2 : float32# }
type t28 = { mutable float0 : float; mutable i32_1 : int32# }
type t29 = { mutable str0 : string; mutable i64_1 : int64# }
type t30 = { mutable n0 : nativeint# }
type t31 = { mutable imm0 : int; mutable str1 : string; mutable float_u2 : float# }
type t32 = { mutable float0 : float; mutable str1 : string; mutable float32_u2 : float32# }
type t33 = { mutable str0 : string; mutable str1 : string; mutable i32_2 : int32# }
type t34 = { mutable float0 : float; mutable i64_1 : int64# }
type t35 = { mutable str0 : string; mutable n1 : nativeint# }
type t36 = { mutable float_u0 : float#; mutable imm1 : int }
type t37 = { mutable str0 : string; mutable float1 : float; mutable float_u2 : float# }
type t38 = { mutable imm0 : int; mutable str1 : string; mutable float32_u2 : float32# }
type t39 = { mutable float0 : float; mutable str1 : string; mutable i32_2 : int32# }
type t40 = { mutable str0 : string; mutable str1 : string; mutable i64_2 : int64# }
type t41 = { mutable float0 : float; mutable n1 : nativeint# }
type t42 = { mutable str0 : string; mutable float_u1 : float#; mutable imm2 : int }
type t43 = { mutable float32_u0 : float32#; mutable imm1 : int }
type t44 = { mutable str0 : string; mutable float1 : float; mutable float32_u2 : float32# }
type t45 = { mutable imm0 : int; mutable str1 : string; mutable i32_2 : int32# }
type t46 = { mutable float0 : float; mutable str1 : string; mutable i64_2 : int64# }
type t47 = { mutable str0 : string; mutable str1 : string; mutable n2 : nativeint# }
type t48 = { mutable float0 : float; mutable float_u1 : float#; mutable imm2 : int }
type t49 = { mutable str0 : string; mutable float32_u1 : float32#; mutable imm2 : int }
type t50 = { mutable i32_0 : int32#; mutable imm1 : int }
type t51 = { mutable imm0 : int; mutable float1 : float; mutable float_u2 : float# }
type t52 = { mutable float0 : float; mutable float1 : float; mutable float32_u2 : float32# }
type t53 = { mutable str0 : string; mutable float1 : float; mutable i32_2 : int32# }
type t54 = { mutable imm0 : int; mutable str1 : string; mutable i64_2 : int64# }
type t55 = { mutable float0 : float; mutable str1 : string; mutable n2 : nativeint# }
type t56 = { mutable str0 : string; mutable str1 : string; mutable float_u2 : float#; mutable imm3 : int }
type t57 = { mutable float0 : float; mutable float32_u1 : float32#; mutable imm2 : int }
type t58 = { mutable str0 : string; mutable i32_1 : int32#; mutable imm2 : int }
type t59 = { mutable i64_0 : int64#; mutable imm1 : int }
type t60 = { mutable str0 : string; mutable str1 : string; mutable str2 : string; mutable float_u3 : float# }
type t61 = { mutable imm0 : int; mutable float1 : float; mutable float32_u2 : float32# }
type t62 = { mutable float0 : float; mutable float1 : float; mutable i32_2 : int32# }
type t63 = { mutable str0 : string; mutable float1 : float; mutable i64_2 : int64# }
type t64 = { mutable imm0 : int; mutable str1 : string; mutable n2 : nativeint# }
type t65 = { mutable float0 : float; mutable str1 : string; mutable float_u2 : float#; mutable imm3 : int }
type t66 = { mutable str0 : string; mutable str1 : string; mutable float32_u2 : float32#; mutable imm3 : int }
type t67 = { mutable float0 : float; mutable i32_1 : int32#; mutable imm2 : int }
type t68 = { mutable str0 : string; mutable i64_1 : int64#; mutable imm2 : int }
type t69 = { mutable n0 : nativeint#; mutable imm1 : int }
type t70 = { mutable float0 : float; mutable str1 : string; mutable str2 : string; mutable float_u3 : float# }
type t71 = { mutable str0 : string; mutable str1 : string; mutable str2 : string; mutable float32_u3 : float32# }
type t72 = { mutable imm0 : int; mutable float1 : float; mutable i32_2 : int32# }
type t73 = { mutable float0 : float; mutable float1 : float; mutable i64_2 : int64# }
type t74 = { mutable str0 : string; mutable float1 : float; mutable n2 : nativeint# }
type t75 =
  | A of float#
  | B of string * float#
type t76 =
