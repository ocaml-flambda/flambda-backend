...
type b = a
type c
  : value mod global unique many uncontended portable coordinated_write
              coordinate_nothing external_
type d = c
|}]
...
type b = a
type c
  : float64 mod global unique many uncontended portable coordinated_write
                coordinate_nothing external_
type d = c
|}]
...
type b = a
type c
  : float32 mod global unique many uncontended portable coordinated_write
                coordinate_nothing external_
type d = c
|}]
...
type b = a
type c
  : word mod local aliased once contended nonportable coordinated_none
             coordinate_writing internal
type d = c
|}]
...
type b = a
type c
  : bits32 mod local aliased once contended nonportable coordinated_none
               coordinate_writing internal
type d = c
|}]
...
type b = a
type c
  : bits64 mod local aliased once contended nonportable coordinated_none
               coordinate_writing internal
type d = c
|}]
