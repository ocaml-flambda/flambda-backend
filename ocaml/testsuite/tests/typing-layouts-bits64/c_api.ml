...
(* Various combinations of arguments int64, int64 [@unboxed], and
   int64# *)
external lognot_UtoU : (int64#[@unboxed]) -> (int64#[@unboxed]) =
  "lognot_bytecode" "lognot_UtoU"
external lognot_BtoU : int64 -> (int64#[@unboxed]) =
  "lognot_bytecode" "lognot_BtoU"
external lognot_UtoB : (int64#[@unboxed]) -> int64 =
  "lognot_bytecode" "lognot_UtoB"
external lognot_BUtoU : (int64[@unboxed]) -> (int64#[@unboxed]) =
  "lognot_bytecode" "lognot_UtoU"
external lognot_UtoBU : (int64#[@unboxed]) -> (int64[@unboxed]) =
  "lognot_bytecode" "lognot_UtoU"
...
external sum_7 :
  (int64#[@unboxed]) -> int64 -> (int64#[@unboxed]) -> int64 ->
  (int64#[@unboxed]) -> int64 -> (int64#[@unboxed]) -> (int64#[@unboxed]) =
