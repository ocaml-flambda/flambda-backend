(* TEST
 flags="-drawlambda -extension dummy_arguments"
 * expect
 *)
   ...
   g/280 =
     (function {nlocal = 0} r/282
       (let (arg/283 = (seq (setfield_ptr 0 r/282 "hello") "world"))
         (function {nlocal = 0} dummy/284 stub ignore assert all zero_alloc
           (function {nlocal = 0} dummy/285 stub ignore assert all zero_alloc
...
(let
  (f/274 = (apply (field 0 (global Toploop!)) "f")
   g/286 =
     (function {nlocal = 0} dummy/287 stub ignore assert all zero_alloc
