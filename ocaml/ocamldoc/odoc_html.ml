...
class html =
  object (self)
    ...
    method html_of_type b t =
      ...
      bs b "</span> ";
      let priv = t.ty_private = Parsetree.Ppriv_private in
      (
      ...
      bp b "<span id=\"%s\">"
        (Naming.type_target
           { ty_name = c.cl_name ;
             ...
             ty_kind = Type_abstract ; ty_private = Ppriv_public;
             ty_manifest = None ;
    ...
    method html_of_class_type b ?(complete=true) ?(with_link=true) ct =
      ...
      bp b "<span id=\"%s\">"
        (Naming.type_target
           { ty_name = ct.clt_name ;
             ty_info = None ; ty_parameters = [] ;
             ty_kind = Type_abstract ; ty_private = Ppriv_public; ty_manifest = None ;
             ty_loc = Odoc_info.dummy_loc ;
             ty_code = None ;
           }
        );
