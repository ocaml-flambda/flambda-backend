...
val of_bytes : bytes -> string @@ portable
...
val to_bytes : string -> bytes @@ portable
...
val blit :
  string -> int -> bytes -> int -> int -> unit @@ portable
...
val concat : string -> string list -> string @@ portable
...
val cat : string -> string -> string @@ portable
...
val starts_with :
  prefix (* comment thwarts tools/sync_stdlib_docs *) :string -> string -> bool @@ portable
...
val ends_with :
  suffix (* comment thwarts tools/sync_stdlib_docs *) :string -> string -> bool @@ portable
(** [ends_with ][~suffix s] is [true] if and only if [s] ends with [suffix].

    @since 4.13 *)

val contains_from : string -> int -> char -> bool @@ portable
(** [contains_from s start c] is [true] if and only if [c] appears in [s]
    after position [start].

    @raise Invalid_argument if [start] is not a valid position in [s]. *)

val rcontains_from : string -> int -> char -> bool @@ portable
...
val contains : string -> char -> bool @@ portable
(** [contains s c] is {!String.contains_from}[ s 0 c]. *)

(** {1:extract Extracting substrings} *)

val sub : string -> int -> int -> string @@ portable
...
val split_on_char : char -> string -> string list @@ portable
...
val index_from : string -> int -> char -> int @@ portable
...
val index_from_opt : string -> int -> char -> int option @@ portable
...
val rindex_from : string -> int -> char -> int @@ portable
...
val rindex_from_opt : string -> int -> char -> int option @@ portable
...
val index : string -> char -> int @@ portable
(** [index s c] is {!String.index_from}[ s 0 c]. *)

val index_opt : string -> char -> int option @@ portable
(** [index_opt s c] is {!String.index_from_opt}[ s 0 c].

    @since 4.05 *)

val rindex : string -> char -> int @@ portable
(** [rindex s c] is {!String.rindex_from}[ s (length s - 1) c]. *)

val rindex_opt : string -> char -> int option @@ portable
...
val get_uint8 : string -> int -> int @@ portable
...
val get_int8 : string -> int -> int @@ portable
...
val get_uint16_ne : string -> int -> int @@ portable
...
val get_uint16_be : string -> int -> int @@ portable
...
val get_uint16_le : string -> int -> int @@ portable
...
val get_int16_ne : string -> int -> int @@ portable
...
val get_int16_be : string -> int -> int @@ portable
...
val get_int16_le : string -> int -> int @@ portable
...
val get_int32_ne : string -> int -> int32 @@ portable
...
val get_int32_be : string -> int -> int32 @@ portable
...
val get_int32_le : string -> int -> int32 @@ portable
...
val get_int64_ne : string -> int -> int64 @@ portable
...
val get_int64_be : string -> int -> int64 @@ portable
...
val get_int64_le : string -> int -> int64 @@ portable
...
external unsafe_blit :
  string -> int -> bytes -> int -> int ->
    unit @@ portable = "caml_blit_string" [@@noalloc]
