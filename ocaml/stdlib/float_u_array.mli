...
val init : int -> (int -> ('a : float64)) -> ('a : float64) array
...
val make_matrix : int -> int -> ('a : float64) -> ('a : float64) array array
...
val create_matrix : int -> int -> ('a : float64) -> ('a : float64) array array
  [@@ocaml.deprecated
...
val sub : ('a : float64) array -> int -> int -> ('a : float64) array
...
val fill : ('a : float64) array -> int -> int -> ('a : float64) -> unit
...
val blit :
  ('a : float64) array -> int -> ('a : float64) array -> int -> int ->
    unit
...
val iter : (('a : float64) -> unit) -> ('a : float64) array -> unit
(** [iter f a] applies function [f] in turn to all
   the elements of [a].  It is equivalent to
   [f a.(0); f a.(1); ...; f a.(length a - 1); ()]. *)

val iteri : (int -> ('a : float64) -> unit) -> ('a : float64) array -> unit
(** Same as {!iter}, but the
   function is applied to the index of the element as first argument,
   and the element itself as second argument. *)

val map : (('a : float64) -> ('b : float64)) -> ('a : float64) array -> ('b : float64) array
(** [map f a] applies function [f] to all the elements of [a],
   and builds an array with the results returned by [f]:
   [[| f a.(0); f a.(1); ...; f a.(length a - 1) |]]. *)

val mapi : (int -> ('a : float64) -> ('b : float64)) -> ('a : float64) array -> ('b : float64) array
(** Same as {!map}, but the
   function is applied to the index of the element as first argument,
   and the element itself as second argument. *)

val fold_left : ('a -> ('b : float64) -> 'a) -> 'a -> ('b : float64) array -> 'a
(** [fold_left f init a] computes
   [f (... (f (f init a.(0)) a.(1)) ...) a.(n-1)],
   where [n] is the length of the array [a]. *)

(* val fold_left_map :
 *   (('a : float64) -> 'b -> ('a : float64) * 'c) -> ('a : float64) -> 'b array -> ('a : float64) * 'c array
 * (** [fold_left_map] is a combination of {!fold_left} and {!map} that threads an
 *     accumulator through calls to [f].
 *     @since 4.13.0 *) *)
(* CR layouts v5: Unboxed values can't be in tuples yet *)

val fold_right : (('b : float64) -> 'a -> 'a) -> ('b : float64) array -> 'a -> 'a
...
val iter2 : (('a : float64) -> ('b : float64) -> unit) -> ('a : float64) array -> ('b : float64) array -> unit
...
val map2 : (('a : float64) -> ('b : float64) -> ('c : float64)) -> ('a : float64) array -> ('b : float64) array -> ('c : float64) array
 ...
 *     @since 4.13.0 *)
 *
 * val find_map : (('a : float64) -> 'b option) -> ('a : float64) array -> 'b option
...
val sort : (('a : float64) -> ('a : float64) -> int) -> ('a : float64) array -> unit
...
val stable_sort : (('a : float64) -> ('a : float64) -> int) -> ('a : float64) array -> unit
...
val fast_sort : (('a : float64) -> ('a : float64) -> int) -> ('a : float64) array -> unit
