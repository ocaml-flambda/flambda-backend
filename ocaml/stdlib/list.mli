...
val fold_left_map :
  ('acc -> 'a -> 'acc * 'b) -> 'acc -> 'a list -> 'acc * 'b list @@ portable
...
val fold_right : ('a -> 'acc -> 'acc) -> 'a list -> 'acc -> 'acc @@ portable
...
val rev_map2 : ('a -> 'b -> 'c) -> 'a list -> 'b list -> 'c list @@ portable
(** [rev_map2 f l1 l2] gives the same result as
   {!rev}[ (]{!map2}[ f l1 l2)], but is more efficient.
 *)

val fold_left2 :
  ('acc -> 'a -> 'b -> 'acc) -> 'acc -> 'a list -> 'b list -> 'acc @@ portable
...
val fold_right2 :
  ('a -> 'b -> 'acc -> 'acc) -> 'a list -> 'b list -> 'acc -> 'acc @@ portable
...
val find_mapi : (int -> 'a -> 'b option) -> 'a list -> 'b option @@ portable
...
val partition_map : ('a -> ('b, 'c) Either.t) -> 'a list -> 'b list * 'c list @@ portable
