...
val symbol_start : unit -> int @@ portable
...
val symbol_end : unit -> int @@ portable
(** See {!Parsing.symbol_start}. *)

val rhs_start : int -> int @@ portable
...
val set_trace: bool -> bool @@ portable
...
val yyparse :
  parse_tables -> int -> (Lexing.lexbuf -> 'a) -> Lexing.lexbuf -> 'b @@ portable
val peek_val : parser_env -> int -> 'a @@ portable
val is_current_lookahead : 'a -> bool @@ portable
val parse_error : string -> unit @@ portable
