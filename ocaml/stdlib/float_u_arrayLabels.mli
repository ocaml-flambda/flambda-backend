...
val init : int -> f:(int -> ('a : float64)) -> ('a : float64) array
...
val make_matrix : dimx:int -> dimy:int -> ('a : float64) -> ('a : float64) array array
...
val copy : ('a : float64) array -> ('a : float64) array
(** [copy a] returns a copy of [a], that is, a fresh array
   containing the same elements as [a]. *)

val fill : ('a : float64) array -> pos:int -> len:int -> ('a : float64) -> unit
...
val blit :
  src:('a : float64) array -> src_pos:int -> dst:('a : float64) array -> dst_pos:int -> len:int ->
    unit
...
(* val to_list : ('a : float64) array -> ('a : float64) list
 * (** [to_list a] returns the list of all the elements of [a]. *)
 *
 * val of_list : ('a : float64) list -> ('a : float64) array
...
val iter : f:(('a : float64) -> unit) -> ('a : float64) array -> unit
(** [iter ~f a] applies function [f] in turn to all
   the elements of [a].  It is equivalent to
   [f a.(0); f a.(1); ...; f a.(length a - 1); ()]. *)

val iteri : f:(int -> ('a : float64) -> unit) -> ('a : float64) array -> unit
(** Same as {!iter}, but the
   function is applied to the index of the element as first argument,
   and the element itself as second argument. *)

val map : f:(('a : float64) -> ('b : float64)) -> ('a : float64) array -> ('b : float64) array
(** [map ~f a] applies function [f] to all the elements of [a],
   and builds an array with the results returned by [f]:
   [[| f a.(0); f a.(1); ...; f a.(length a - 1) |]]. *)

val mapi : f:(int -> ('a : float64) -> ('b : float64)) -> ('a : float64) array -> ('b : float64) array
(** Same as {!map}, but the
   function is applied to the index of the element as first argument,
   and the element itself as second argument. *)

val fold_left : f:('a -> ('b : float64) -> 'a) -> init:'a -> ('b : float64) array -> 'a
(** [fold_left ~f ~init a] computes
   [f (... (f (f init a.(0)) a.(1)) ...) a.(n-1)],
   where [n] is the length of the array [a]. *)

(* val fold_left_map :
 *   f:(('a : float64) -> 'b -> ('a : float64) * 'c) -> init:('a : float64) -> 'b array -> ('a : float64) * 'c array
 * (** [fold_left_map] is a combination of {!fold_left} and {!map} that threads an
 *     accumulator through calls to [f].
 *     @since 4.13.0 *) *)
(* CR layouts v5: Unboxed values can't be in tuples yet *)

val fold_right : f:(('b : float64) -> 'a -> 'a) -> ('b : float64) array -> init:'a -> 'a
...
val iter2 : f:(('a : float64) -> ('b : float64) -> unit) -> ('a : float64) array -> ('b : float64) array -> unit
...
val map2 : f:(('a : float64) -> ('b : float64) -> ('c : float64)) -> ('a : float64) array -> ('b : float64) array -> ('c : float64) array
 ...
 *     @since 4.13.0 *)
 *
 * val find_map : f:(('a : float64) -> 'b option) -> ('a : float64) array -> 'b option
...
(* val split : (('a : float64) * 'b) array -> ('a : float64) array * 'b array
 * (** [split [|(a1,b1); ...; (an,bn)|]] is [([|a1; ...; an|], [|b1; ...; bn|])].
 *
 *     @since 4.13.0 *)
 *
 * val combine : ('a : float64) array -> 'b array -> (('a : float64) * 'b) array
...
val sort : cmp:(('a : float64) -> ('a : float64) -> int) -> ('a : float64) array -> unit
...
val stable_sort : cmp:(('a : float64) -> ('a : float64) -> int) -> ('a : float64) array -> unit
...
val fast_sort : cmp:(('a : float64) -> ('a : float64) -> int) -> ('a : float64) array -> unit
 ...
 *     @since 4.07 *)
 *
 * val of_seq : ('a : float64) Seq.t -> ('a : float64) array
