...
val zero : nativeint @@ portable
(** The native integer 0.*)

val one : nativeint @@ portable
(** The native integer 1.*)

val minus_one : nativeint @@ portable
(** The native integer -1.*)
...
val unsigned_div : nativeint -> nativeint -> nativeint @@ portable
...
val lognot : nativeint -> nativeint @@ portable
...
external shift_right_logical :
  (nativeint[@local_opt]) -> int -> (nativeint[@local_opt]) @@ portable = "%nativeint_lsr"
...
val unsigned_to_int : nativeint -> int option @@ portable
...
val of_string_opt: string -> nativeint option @@ portable
(** Same as [of_string], but return [None] instead of raising.
    @since 4.05 *)

val to_string : nativeint -> string @@ portable
