...
(* CR less-tco: Find a better place for tail_attribute and
...
type position_and_tail_attribute =
  (* For "phantom" applications generated by builtins/tuplify/
     partial application closures generated by the compiler. *)
  | Unknown_position
  (* Tail_position really means "both in the tail of a region and in the tail
     of a function." *)
