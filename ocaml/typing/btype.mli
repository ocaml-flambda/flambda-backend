...
val newgenvar: ?name:string -> Higher_jkind.t -> type_expr
        (* Return a fresh generic variable *)
val newgenstub: scope:int -> Higher_jkind.t -> type_expr
...
val iter_type_expr_noun: (type_expr -> unit) -> (type_noun -> unit)
