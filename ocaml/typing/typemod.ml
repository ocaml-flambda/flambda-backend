          ...
          | Structure ->
              ...
              let sg =
                ...
                | _ ->
                  ...
                  in
                  let recursive =
                    not @@ Builtin_attributes.has_attribute ["ocaml.no_recursive_modalities"; "no_recursive_modalities"] attrs
                  in
  ...
  let transl_include ~loc env sig_acc sincl modalities =
    ...
    let sg, modalities =
      ...
      | _ ->
        ...
        in
        let recursive =
          not @@ Builtin_attributes.has_attribute ["no_recursive_modalities"; "ocaml.no_recursive_modalities"]
