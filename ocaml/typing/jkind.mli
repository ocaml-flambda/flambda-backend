...
val combine_histories_higher :
  History.interact_reason ->
  higher ->
  higher ->
  Types.type_expr Jkind_types.history
...
val format_history_higher :
  intro:(Format.formatter -> unit) -> Format.formatter -> higher -> unit
