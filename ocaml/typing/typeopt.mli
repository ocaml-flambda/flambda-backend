...
val array_type_kind :
  elt_sort:(Jkind.Type.Sort.t option)
  -> Env.t -> Location.t -> Types.type_expr -> Lambda.array_kind
val array_kind :
  Typedtree.expression -> Jkind.Type.Sort.t -> Lambda.array_kind
val array_pattern_kind :
  Typedtree.pattern -> Jkind.Type.Sort.t -> Lambda.array_kind
...
*)
val layout :
  Env.t -> Location.t -> Jkind.Type.sort -> Types.type_expr -> Lambda.layout
...
val layout_of_sort : Location.t -> Jkind.Type.sort -> Lambda.layout
val layout_of_const_sort : Jkind.Type.Sort.const -> Lambda.layout
