...
let comp_primitive p args =
  match p with
    Pgetglobal cu -> Kgetglobal (cu |> Compilation_unit.to_global_ident_for_legacy_code)
  | Psetglobal cu -> Ksetglobal (cu |> Compilation_unit.to_global_ident_for_legacy_code)
