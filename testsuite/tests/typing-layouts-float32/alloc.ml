...
let print_record_and_allocs s r =
  ...
  Printf.printf
    "%s:\n  allocated bytes: %.2f\n  a: %.2f\n  b: %.2f\n  c: %.2f\n  d: %.2f\n"
    s allocs
    (Stdlib_beta.Float32.to_float (Float32_u.to_float32 r.a))
    (Stdlib_beta.Float32.to_float (Float32_u.to_float32 r.b))
    (Stdlib_beta.Float32.to_float (Float32_u.to_float32 r.c))
    (Stdlib_beta.Float32.to_float (Float32_u.to_float32 r.d))
