(* TEST
<<<<<<< HEAD:testsuite/tests/typing-layouts-unboxed-records/unused.ml
 flags = " -w +A -strict-sequence -extension layouts_alpha";
||||||| dc6e300e9e:testsuite/tests/typing-layouts-unboxed-records/unused.ml
 flags = " -w +A -strict-sequence -extension layouts_beta";
=======
 flags = " -w +A -strict-sequence";
>>>>>>> origin/main:testsuite/tests/typing-layouts-products/unused_unboxed_records.ml
 expect;
*)
