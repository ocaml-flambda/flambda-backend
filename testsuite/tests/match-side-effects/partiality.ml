...
(let
  (f/291 =
     (function {nlocal = 0} x/292 : int
       (let (*match*/294 =o (field_int 0 x/292))
         (if *match*/294
           (let (*match*/296 =o (field_mut 1 x/292))
             (if *match*/296 (field_mut 0 *match*/296) 1))
           0))))
       ...
       (region
         (let
           ...
           (catch
             (if *match*/301
               (let
                 (*match*/302 =o (field_mut 0 *match*/301)
                  *match*/303 =o (field_mut 0 *match*/302))
            ...
            with (7)
             (if (seq (setfield_ptr 0 r/299 0) 0) 1
               (if *match*/301
                 (let
                   (*match*/304 =o (field_mut 0 *match*/301)
                    *match*/305 =o (field_mut 0 *match*/304))
                   (field_mut 0 *match*/305))
                 3)))))))
...
(let
  (test/309 =
     (function {nlocal = 0} param/312[(consts (0)) (non_consts ([0: *]))]
       : int
       (if param/312
         (let (*match*/313 =o (field_mut 0 param/312))
           (field_mut 0 *match*/313))
         0)))
  ...
  (test/317 =
     (function {nlocal = 0} param/319 : int
       (let (*match*/320 =o (field_mut 0 param/319))
         (if *match*/320
           (let (*match*/321 =o (field_mut 0 *match*/320))
             (field_mut 0 *match*/321))
           0))))
     ...
     (function {nlocal = 0} n/326 : int
       (region
         (let
           ...
           (if *match*/329
             (let
               (*match*/330 =o (field_mut 0 *match*/329)
                *match*/331 =o (field_mut 0 *match*/330)
                *match*/332 =o (field_mut 0 *match*/331))
               (if *match*/332
                 (let (*match*/333 =o (field_mut 1 *match*/330))
                   (field_mut 0 *match*/333))
                 (let
                   (*match*/334 =o (field_mut 1 *match*/330)
                    n/328 =o (field_mut 0 *match*/334))
                   (~ n/328))))
             3)))))
