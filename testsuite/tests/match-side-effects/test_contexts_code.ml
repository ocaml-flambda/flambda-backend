...
(let
  (example_2/338 =
     (function {nlocal = 0} param/342[int]
       [(consts ()) (non_consts ([1: *] [0: *]))](region
                                                   (let
                                                     (input/340 =[(consts ())
                                                                  (non_consts (
                                                     ...
                                                     (if
                                                       ...
                                                       (let
                                                         ...
                                                         (switch* *match*/346
                                                          ...
                                                          case tag 1: [1: 2]))
                                                       [1: 1])))))
  (apply (field_imm 1 (global Toploop!)) "example_2" example_2/338))
...
(let
  (example_3/356 =
     (function {nlocal = 0} param/360[int]
       [(consts ()) (non_consts ([1: *] [0: *]))](region
                                                   (let
                                                     (input/358 =mut[(consts ())
                                                                    (non_consts (
                                                                    [0:
                                                                    [int],
                                                                    [(consts ())
                                                     ...
                                                     (if
                                                       ...
                                                       (switch* (field_imm 1
                                                        ...
                                                        case tag 1: [1: 2])
                                                       [1: 1])))))
  (apply (field_imm 1 (global Toploop!)) "example_3" example_3/356))
