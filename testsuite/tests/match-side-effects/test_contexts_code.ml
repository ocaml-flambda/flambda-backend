...
(let
  (example_1/302 =
     (function {nlocal = 0} param/326[int]
                                                     ...
                                                     (if
                                                       ...
                                                       (let
                                                         ...
                                                         (switch* *match*/329
                                                          ...
                                                          case tag 1: [1: 2]))
                                                       [1: 1])))))
  (apply (field_imm 1 (global Toploop!)) "example_1" example_1/302))
...
(let
  (example_2/341 =
     (function {nlocal = 0} param/345[int]
       [(consts ()) (non_consts ([1: *] [0: *]))](region
                                                   (let
                                                     (input/343 =[(consts ())
                                                                  (non_consts (
                                                     ...
                                                     (if
                                                       ...
                                                       (let
                                                         ...
                                                         (switch* *match*/349
                                                          ...
                                                          case tag 1: [1: 2]))
                                                       [1: 1])))))
  (apply (field_imm 1 (global Toploop!)) "example_2" example_2/341))
...
(let
  (example_3/359 =
     (function {nlocal = 0} param/363[int]
       [(consts ()) (non_consts ([1: *] [0: *]))](region
                                                   (let
                                                     (input/361 =mut[(consts ())
                                                                    (non_consts (
                                                                    [0:
                                                                    [int],
                                                                    [(consts ())
                                                     ...
                                                     (if
                                                       ...
                                                       (switch* (field_imm 1
                                                        ...
                                                        case tag 1: [1: 2])
                                                       [1: 1])))))
  (apply (field_imm 1 (global Toploop!)) "example_3" example_3/359))
