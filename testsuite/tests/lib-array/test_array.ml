...
a;;
[%%expect{|
val a : '_weak1 option array @@ global many =
...
a;;
[%%expect{|
val a : float array @@ global many = [|0.; 0.; 0.; 0.; 0.; 0.; 0.; 0.|]
- : unit = ()
...
let _ = Array.split a;;
[%%expect{|
val a : (int * char) array @@ global many = [|(1, 'a'); (2, 'b'); (3, 'c')|]
...
[%%expect{|
val a : int array @@ global many = [|1; 2; 3|]
val b : char array @@ global many = [|'a'; 'b'; 'c'|]
...
[%%expect{|
val a : char array @@ global many = [|'a'; 'b'; 'c'|]
- : int option = Some 121
|}]
...
[%%expect{|
val a : int array @@ global many = [|1; 2|]
- : int option = None
|}]
...
a (* [a] is unchanged *);;
[%%expect {|
val a : int array @@ global many = [|1; 2; 3; 4; 5; 6; 7; 8|]
...
let a : int array =
  ...
  a
[%%expect{|
val a : int array @@ global many = [|2; 4; 6; 8|]
|}]
...
[%%expect{|
val a : string array array @@ global many =
...
[%%expect{|
val a : int array array @@ global many = [|[|0; 1; 2|]; [|10; 11; 12|]|]
|}]
