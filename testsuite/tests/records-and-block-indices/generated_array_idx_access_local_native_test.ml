...
let test size =
  ...
  (* Create an array of size [size] *)
  let a : int64x2# array = makearray_dynamic_local size (interleave_low_64 (int64x2_of_int64 0L) (int64x2_of_int64 1L)) in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (*   t37 = #{ int64x2# }   *)
  (***************************)
  let eq = (fun #{ a37 = a371 } #{ a37 = a372 } -> int64x2_u_equal a371 a372) in
  let mk_value i = #{ a37 = (interleave_low_64 (int64x2_of_int64 (Int64.of_int (i + 0))) (int64x2_of_int64 (Int64.of_int (i + 1)))) } in
  (* Create an array of size [size] *)
  let a : t37 array = makearray_dynamic_local size #{ a37 = (interleave_low_64 (int64x2_of_int64 0L) (int64x2_of_int64 1L)) } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (*   t38 = #{ #{ int } }   *)
  (***************************)
  let eq = (fun #{ a38 = a381 } #{ a38 = a382 } -> (fun #{ a0 = a01 } #{ a0 = a02 } -> (fun a b -> Int.equal a b) a01 a02) a381 a382) in
  let mk_value i = #{ a38 = #{ a0 = (i + 0) } } in
  (* Create an array of size [size] *)
  let a : t38 array = makearray_dynamic_local size #{ a38 = #{ a0 = 0 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (*   t39 = #{ #{ int }; int }   *)
  (********************************)
  let eq = (fun #{ a39 = a391; b39 = b391 } #{ a39 = a392; b39 = b392 } -> (fun #{ a0 = a01 } #{ a0 = a02 } -> (fun a b -> Int.equal a b) a01 a02) a391 a392 && (fun a b -> Int.equal a b) b391 b392) in
  let mk_value i = #{ a39 = #{ a0 = (i + 0) }; b39 = (i + 1) } in
  (* Create an array of size [size] *)
  let a : t39 array = makearray_dynamic_local size #{ a39 = #{ a0 = 0 }; b39 = 1 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (*   t40 = #{ #{ int }; int32# }   *)
  (***********************************)
  let eq = (fun #{ a40 = a401; b40 = b401 } #{ a40 = a402; b40 = b402 } -> (fun #{ a0 = a01 } #{ a0 = a02 } -> (fun a b -> Int.equal a b) a01 a02) a401 a402 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b401 b402) in
  let mk_value i = #{ a40 = #{ a0 = (i + 0) }; b40 = Int32_u.of_int (i + 1) } in
  (* Create an array of size [size] *)
  let a : t40 array = makearray_dynamic_local size #{ a40 = #{ a0 = 0 }; b40 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a40.#a0) : (t40 array, _) idx_mut) next_el.#a40.#a0;
    mark_test_run 192;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t41 = #{ #{ int; int } }   *)
  (********************************)
  let eq = (fun #{ a41 = a411 } #{ a41 = a412 } -> (fun #{ a1 = a11; b1 = b11 } #{ a1 = a12; b1 = b12 } -> (fun a b -> Int.equal a b) a11 a12 && (fun a b -> Int.equal a b) b11 b12) a411 a412) in
  let mk_value i = #{ a41 = #{ a1 = (i + 0); b1 = (i + 1) } } in
  (* Create an array of size [size] *)
  let a : t41 array = makearray_dynamic_local size #{ a41 = #{ a1 = 0; b1 = 1 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (*   t42 = #{ #{ int; int }; int }   *)
  (*************************************)
  let eq = (fun #{ a42 = a421; b42 = b421 } #{ a42 = a422; b42 = b422 } -> (fun #{ a1 = a11; b1 = b11 } #{ a1 = a12; b1 = b12 } -> (fun a b -> Int.equal a b) a11 a12 && (fun a b -> Int.equal a b) b11 b12) a421 a422 && (fun a b -> Int.equal a b) b421 b422) in
  let mk_value i = #{ a42 = #{ a1 = (i + 0); b1 = (i + 1) }; b42 = (i + 2) } in
  (* Create an array of size [size] *)
  let a : t42 array = makearray_dynamic_local size #{ a42 = #{ a1 = 0; b1 = 1 }; b42 = 2 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (*   t43 = #{ #{ int; int }; int32# }   *)
  (****************************************)
  let eq = (fun #{ a43 = a431; b43 = b431 } #{ a43 = a432; b43 = b432 } -> (fun #{ a1 = a11; b1 = b11 } #{ a1 = a12; b1 = b12 } -> (fun a b -> Int.equal a b) a11 a12 && (fun a b -> Int.equal a b) b11 b12) a431 a432 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b431 b432) in
  let mk_value i = #{ a43 = #{ a1 = (i + 0); b1 = (i + 1) }; b43 = Int32_u.of_int (i + 2) } in
  (* Create an array of size [size] *)
  let a : t43 array = makearray_dynamic_local size #{ a43 = #{ a1 = 0; b1 = 1 }; b43 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  for i = 0 to size - 1 do
    ...
    let el = get a i in
    (* Path: [.#a43.#a1] *)
    let el = #{ el with a43 = #{ el.#a43 with a1 = next_el.#a43.#a1 } } in
    Idx_mut.unsafe_set a ((.(i).#a43.#a1) : (t43 array, _) idx_mut) next_el.#a43.#a1;
    mark_test_run 208;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 208 failed %d %d" size i;
    (* Path: [.#a43.#b1] *)
    let el = #{ el with a43 = #{ el.#a43 with b1 = next_el.#a43.#b1 } } in
    Idx_mut.unsafe_set a ((.(i).#a43.#b1) : (t43 array, _) idx_mut) next_el.#a43.#b1;
    mark_test_run 209;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t44 = #{ #{ int; int32# } }   *)
  (***********************************)
  let eq = (fun #{ a44 = a441 } #{ a44 = a442 } -> (fun #{ a6 = a61; b6 = b61 } #{ a6 = a62; b6 = b62 } -> (fun a b -> Int.equal a b) a61 a62 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b61 b62) a441 a442) in
  let mk_value i = #{ a44 = #{ a6 = (i + 0); b6 = Int32_u.of_int (i + 1) } } in
  (* Create an array of size [size] *)
  let a : t44 array = makearray_dynamic_local size #{ a44 = #{ a6 = 0; b6 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (*   t45 = #{ #{ int; int32# }; int32# }   *)
  (*******************************************)
  let eq = (fun #{ a45 = a451; b45 = b451 } #{ a45 = a452; b45 = b452 } -> (fun #{ a6 = a61; b6 = b61 } #{ a6 = a62; b6 = b62 } -> (fun a b -> Int.equal a b) a61 a62 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b61 b62) a451 a452 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b451 b452) in
  let mk_value i = #{ a45 = #{ a6 = (i + 0); b6 = Int32_u.of_int (i + 1) }; b45 = Int32_u.of_int (i + 2) } in
  (* Create an array of size [size] *)
  let a : t45 array = makearray_dynamic_local size #{ a45 = #{ a6 = 0; b6 = #1l }; b45 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  for i = 0 to size - 1 do
    ...
    let el = get a i in
    (* Path: [.#a45.#a6] *)
    let el = #{ el with a45 = #{ el.#a45 with a6 = next_el.#a45.#a6 } } in
    Idx_mut.unsafe_set a ((.(i).#a45.#a6) : (t45 array, _) idx_mut) next_el.#a45.#a6;
    mark_test_run 219;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 219 failed %d %d" size i;
    (* Path: [.#a45.#b6] *)
    let el = #{ el with a45 = #{ el.#a45 with b6 = next_el.#a45.#b6 } } in
    Idx_mut.unsafe_set a ((.(i).#a45.#b6) : (t45 array, _) idx_mut) next_el.#a45.#b6;
    mark_test_run 220;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t46 = #{ #{ int32# } }   *)
  (******************************)
  let eq = (fun #{ a46 = a461 } #{ a46 = a462 } -> (fun #{ a12 = a121 } #{ a12 = a122 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a121 a122) a461 a462) in
  let mk_value i = #{ a46 = #{ a12 = Int32_u.of_int (i + 0) } } in
  (* Create an array of size [size] *)
  let a : t46 array = makearray_dynamic_local size #{ a46 = #{ a12 = #0l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (*   t47 = #{ #{ int32# }; int32# }   *)
  (**************************************)
  let eq = (fun #{ a47 = a471; b47 = b471 } #{ a47 = a472; b47 = b472 } -> (fun #{ a12 = a121 } #{ a12 = a122 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a121 a122) a471 a472 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b471 b472) in
  let mk_value i = #{ a47 = #{ a12 = Int32_u.of_int (i + 0) }; b47 = Int32_u.of_int (i + 1) } in
  (* Create an array of size [size] *)
  let a : t47 array = makearray_dynamic_local size #{ a47 = #{ a12 = #0l }; b47 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  for i = 0 to size - 1 do
    ...
    let el = get a i in
    (* Path: [.#a47.#a12] *)
    let el = #{ el with a47 = #{ el.#a47 with a12 = next_el.#a47.#a12 } } in
    Idx_mut.unsafe_set a ((.(i).#a47.#a12) : (t47 array, _) idx_mut) next_el.#a47.#a12;
    mark_test_run 229;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t48 = #{ #{ int32#; int32# } }   *)
  (**************************************)
  let eq = (fun #{ a48 = a481 } #{ a48 = a482 } -> (fun #{ a14 = a141; b14 = b141 } #{ a14 = a142; b14 = b142 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a141 a142 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b141 b142) a481 a482) in
  let mk_value i = #{ a48 = #{ a14 = Int32_u.of_int (i + 0); b14 = Int32_u.of_int (i + 1) } } in
  (* Create an array of size [size] *)
  let a : t48 array = makearray_dynamic_local size #{ a48 = #{ a14 = #0l; b14 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (**********************************************)
  let eq = (fun #{ a49 = a491; b49 = b491 } #{ a49 = a492; b49 = b492 } -> (fun #{ a14 = a141; b14 = b141 } #{ a14 = a142; b14 = b142 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a141 a142 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b141 b142) a491 a492 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b491 b492) in
  let mk_value i = #{ a49 = #{ a14 = Int32_u.of_int (i + 0); b14 = Int32_u.of_int (i + 1) }; b49 = Int32_u.of_int (i + 2) } in
  (* Create an array of size [size] *)
  let a : t49 array = makearray_dynamic_local size #{ a49 = #{ a14 = #0l; b14 = #1l }; b49 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  for i = 0 to size - 1 do
    ...
    let el = get a i in
    (* Path: [.#a49.#a14] *)
    let el = #{ el with a49 = #{ el.#a49 with a14 = next_el.#a49.#a14 } } in
    Idx_mut.unsafe_set a ((.(i).#a49.#a14) : (t49 array, _) idx_mut) next_el.#a49.#a14;
    mark_test_run 239;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 239 failed %d %d" size i;
    (* Path: [.#a49.#b14] *)
    let el = #{ el with a49 = #{ el.#a49 with b14 = next_el.#a49.#b14 } } in
    Idx_mut.unsafe_set a ((.(i).#a49.#b14) : (t49 array, _) idx_mut) next_el.#a49.#b14;
    mark_test_run 240;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t50 = #{ #{ float# } }   *)
  (******************************)
  let eq = (fun #{ a50 = a501 } #{ a50 = a502 } -> (fun #{ a32 = a321 } #{ a32 = a322 } -> (fun a b -> Float_u.(equal (add #0. a) (add #0. b))) a321 a322) a501 a502) in
  let mk_value i = #{ a50 = #{ a32 = Float_u.of_int (i + 0) } } in
  (* Create an array of size [size] *)
  let a : t50 array = makearray_dynamic_local size #{ a50 = #{ a32 = #0. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (*   t51 = #{ #{ float# }; float# }   *)
  (**************************************)
  let eq = (fun #{ a51 = a511; b51 = b511 } #{ a51 = a512; b51 = b512 } -> (fun #{ a32 = a321 } #{ a32 = a322 } -> (fun a b -> Float_u.(equal (add #0. a) (add #0. b))) a321 a322) a511 a512 && (fun a b -> Float_u.(equal (add #0. a) (add #0. b))) b511 b512) in
  let mk_value i = #{ a51 = #{ a32 = Float_u.of_int (i + 0) }; b51 = Float_u.of_int (i + 1) } in
  (* Create an array of size [size] *)
  let a : t51 array = makearray_dynamic_local size #{ a51 = #{ a32 = #0. }; b51 = #1. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  for i = 0 to size - 1 do
    ...
    let el = get a i in
    (* Path: [.#a51.#a32] *)
    let el = #{ el with a51 = #{ el.#a51 with a32 = next_el.#a51.#a32 } } in
    Idx_mut.unsafe_set a ((.(i).#a51.#a32) : (t51 array, _) idx_mut) next_el.#a51.#a32;
    mark_test_run 249;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t52 = #{ #{ float#; float# } }   *)
  (**************************************)
  let eq = (fun #{ a52 = a521 } #{ a52 = a522 } -> (fun #{ a33 = a331; b33 = b331 } #{ a33 = a332; b33 = b332 } -> (fun a b -> Float_u.(equal (add #0. a) (add #0. b))) a331 a332 && (fun a b -> Float_u.(equal (add #0. a) (add #0. b))) b331 b332) a521 a522) in
  let mk_value i = #{ a52 = #{ a33 = Float_u.of_int (i + 0); b33 = Float_u.of_int (i + 1) } } in
  (* Create an array of size [size] *)
  let a : t52 array = makearray_dynamic_local size #{ a52 = #{ a33 = #0.; b33 = #1. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (**********************************************)
  let eq = (fun #{ a53 = a531; b53 = b531 } #{ a53 = a532; b53 = b532 } -> (fun #{ a33 = a331; b33 = b331 } #{ a33 = a332; b33 = b332 } -> (fun a b -> Float_u.(equal (add #0. a) (add #0. b))) a331 a332 && (fun a b -> Float_u.(equal (add #0. a) (add #0. b))) b331 b332) a531 a532 && (fun a b -> Float_u.(equal (add #0. a) (add #0. b))) b531 b532) in
  let mk_value i = #{ a53 = #{ a33 = Float_u.of_int (i + 0); b33 = Float_u.of_int (i + 1) }; b53 = Float_u.of_int (i + 2) } in
  (* Create an array of size [size] *)
  let a : t53 array = makearray_dynamic_local size #{ a53 = #{ a33 = #0.; b33 = #1. }; b53 = #2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  for i = 0 to size - 1 do
    ...
    let el = get a i in
    (* Path: [.#a53.#a33] *)
    let el = #{ el with a53 = #{ el.#a53 with a33 = next_el.#a53.#a33 } } in
    Idx_mut.unsafe_set a ((.(i).#a53.#a33) : (t53 array, _) idx_mut) next_el.#a53.#a33;
    mark_test_run 259;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 259 failed %d %d" size i;
    (* Path: [.#a53.#b33] *)
    let el = #{ el with a53 = #{ el.#a53 with b33 = next_el.#a53.#b33 } } in
    Idx_mut.unsafe_set a ((.(i).#a53.#b33) : (t53 array, _) idx_mut) next_el.#a53.#b33;
    mark_test_run 260;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t54 = #{ #{ int64x2# } }   *)
  (********************************)
  let eq = (fun #{ a54 = a541 } #{ a54 = a542 } -> (fun #{ a37 = a371 } #{ a37 = a372 } -> int64x2_u_equal a371 a372) a541 a542) in
  let mk_value i = #{ a54 = #{ a37 = (interleave_low_64 (int64x2_of_int64 (Int64.of_int (i + 0))) (int64x2_of_int64 (Int64.of_int (i + 1)))) } } in
  (* Create an array of size [size] *)
  let a : t54 array = makearray_dynamic_local size #{ a54 = #{ a37 = (interleave_low_64 (int64x2_of_int64 0L) (int64x2_of_int64 1L)) } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  for i = 0 to size - 1 do
    ...
    let el = get a i in
    (* Path: [.#a54.#a37] *)
    let el = #{ el with a54 = #{ el.#a54 with a37 = next_el.#a54.#a37 } } in
    Idx_mut.unsafe_set a ((.(i).#a54.#a37) : (t54 array, _) idx_mut) next_el.#a54.#a37;
    mark_test_run 264;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
