...
let test size =
  ...
  (* Create an array of size [size] *)
  let a : t12 array = makearray_dynamic_local size #{ a12 = 0; b12 = #{ a9 = 1; b9 = #{ a0 = 2 } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t15 array = makearray_dynamic_local size #{ a15 = 0; b15 = #{ a14 = 1; b14 = #{ a13 = #2l } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t14 array = makearray_dynamic_local size #{ a14 = 0; b14 = #{ a13 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t19 array = makearray_dynamic_local size #{ a19 = 0; b19 = #{ a18 = #1l; b18 = #{ a13 = #2l } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t21 array = makearray_dynamic_local size #{ a21 = 0; b21 = #{ a20 = #{ a1 = 1; b1 = 2 } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t23 array = makearray_dynamic_local size #{ a23 = 0; b23 = #{ a22 = #{ a6 = 1; b6 = #2l } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t25 array = makearray_dynamic_local size #{ a25 = 0; b25 = #{ a24 = #{ a16 = #1l; b16 = #2l } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t26 array = makearray_dynamic_local size #{ a26 = 0L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t27 array = makearray_dynamic_local size #{ a27 = 0L; b27 = 1 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t28 array = makearray_dynamic_local size #{ a28 = 0L; b28 = 1L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t29 array = makearray_dynamic_local size #{ a29 = #0L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t30 array = makearray_dynamic_local size #{ a30 = #0L; b30 = #1L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t31 array = makearray_dynamic_local size #{ a31 = #0L; b31 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t32 array = makearray_dynamic_local size #{ a32 = #0L; b32 = #1n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t13 array = makearray_dynamic_local size #{ a13 = #0l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t33 array = makearray_dynamic_local size #{ a33 = #0l; b33 = #1L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t34 array = makearray_dynamic_local size #{ a34 = #0l; b34 = #1l; c34 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t35 array = makearray_dynamic_local size #{ a35 = #0l; b35 = #1n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t18 array = makearray_dynamic_local size #{ a18 = #0l; b18 = #{ a13 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t36 array = makearray_dynamic_local size #{ a36 = #0l; b36 = #{ a16 = #1l; b16 = #2l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t37 array = makearray_dynamic_local size #{ a37 = #0l; b37 = #{ a18 = #1l; b18 = #{ a13 = #2l } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t38 array = makearray_dynamic_local size #{ a38 = #0l; b38 = #{ a24 = #{ a16 = #1l; b16 = #2l } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t39 array = makearray_dynamic_local size #{ a39 = #0n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t40 array = makearray_dynamic_local size #{ a40 = #0n; b40 = #1L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t41 array = makearray_dynamic_local size #{ a41 = #0n; b41 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t42 array = makearray_dynamic_local size #{ a42 = #0n; b42 = #1n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t43 array = makearray_dynamic_local size #{ a43 = #0. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t44 array = makearray_dynamic_local size #{ a44 = #0.; b44 = #1. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t45 array = makearray_dynamic_local size #{ a45 = #0.; b45 = #1.; c45 = #2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t46 array = makearray_dynamic_local size #{ a46 = #0.; b46 = #{ a43 = #1. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t47 array = makearray_dynamic_local size #{ a47 = #0.; b47 = #{ a44 = #1.; b44 = #2. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t48 array = makearray_dynamic_local size #{ a48 = #0.; b48 = #{ a46 = #1.; b46 = #{ a43 = #2. } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t50 array = makearray_dynamic_local size #{ a50 = #0.; b50 = #{ a49 = #{ a44 = #1.; b44 = #2. } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t51 array = makearray_dynamic_local size #{ a51 = #{ a0 = 0 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t52 array = makearray_dynamic_local size #{ a52 = #{ a0 = 0 }; b52 = 1 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t53 array = makearray_dynamic_local size #{ a53 = #{ a0 = 0 }; b53 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t20 array = makearray_dynamic_local size #{ a20 = #{ a1 = 0; b1 = 1 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t54 array = makearray_dynamic_local size #{ a54 = #{ a1 = 0; b1 = 1 }; b54 = 2 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t55 array = makearray_dynamic_local size #{ a55 = #{ a1 = 0; b1 = 1 }; b55 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t22 array = makearray_dynamic_local size #{ a22 = #{ a6 = 0; b6 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t56 array = makearray_dynamic_local size #{ a56 = #{ a6 = 0; b6 = #1l }; b56 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t57 array = makearray_dynamic_local size #{ a57 = #{ a10 = 0; b10 = #{ a1 = 1; b1 = 2 } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t58 array = makearray_dynamic_local size #{ a58 = #{ a11 = 0; b11 = #{ a6 = 1; b6 = #2l } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t59 array = makearray_dynamic_local size #{ a59 = #{ a17 = 0; b17 = #{ a16 = #1l; b16 = #2l } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t60 array = makearray_dynamic_local size #{ a60 = #{ a13 = #0l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t61 array = makearray_dynamic_local size #{ a61 = #{ a13 = #0l }; b61 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t24 array = makearray_dynamic_local size #{ a24 = #{ a16 = #0l; b16 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t62 array = makearray_dynamic_local size #{ a62 = #{ a16 = #0l; b16 = #1l }; b62 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t63 array = makearray_dynamic_local size #{ a63 = #{ a36 = #0l; b36 = #{ a16 = #1l; b16 = #2l } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t64 array = makearray_dynamic_local size #{ a64 = #{ a43 = #0. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t65 array = makearray_dynamic_local size #{ a65 = #{ a43 = #0. }; b65 = #1. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t49 array = makearray_dynamic_local size #{ a49 = #{ a44 = #0.; b44 = #1. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t66 array = makearray_dynamic_local size #{ a66 = #{ a44 = #0.; b44 = #1. }; b66 = #2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t67 array = makearray_dynamic_local size #{ a67 = #{ a47 = #0.; b47 = #{ a44 = #1.; b44 = #2. } } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t68 array = makearray_dynamic_local size #{ a68 = #{ a54 = #{ a1 = 0; b1 = 1 }; b54 = 2 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t69 array = makearray_dynamic_local size #{ a69 = #{ a55 = #{ a1 = 0; b1 = 1 }; b55 = #2l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t70 array = makearray_dynamic_local size #{ a70 = #{ a56 = #{ a6 = 0; b6 = #1l }; b56 = #2l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t71 array = makearray_dynamic_local size #{ a71 = #{ a62 = #{ a16 = #0l; b16 = #1l }; b62 = #2l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t72 array = makearray_dynamic_local size #{ a72 = #{ a66 = #{ a44 = #0.; b44 = #1. }; b66 = #2. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
