...
let test size =
  ...
  (* Create an array of size [size] *)
  let a : unit_u array = makearray_dynamic_local size (unbox_unit ()) in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t9 array = makearray_dynamic_local size #{ a9 = 0; b9 = (unbox_unit ()) } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t10 array = makearray_dynamic_local size #{ a10 = 0; b10 = #{ a0 = 1 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t11 array = makearray_dynamic_local size #{ a11 = 0; b11 = #{ a1 = 1; b1 = 2 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t12 array = makearray_dynamic_local size #{ a12 = 0; b12 = #{ a6 = 1; b6 = #2l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t16 array = makearray_dynamic_local size #{ a16 = 0; b16 = #{ a15 = #1l; b15 = #2l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t18 array = makearray_dynamic_local size #{ a18 = 0L; b18 = 1 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t20 array = makearray_dynamic_local size #{ a20 = 0L; b20 = (unbox_unit ()) } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t21 array = makearray_dynamic_local size #{ a21 = #0L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t22 array = makearray_dynamic_local size #{ a22 = #0L; b22 = #1L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t24 array = makearray_dynamic_local size #{ a24 = #0L; b24 = #1n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t25 array = makearray_dynamic_local size #{ a25 = #0L; b25 = (unbox_unit ()) } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t15 array = makearray_dynamic_local size #{ a15 = #0l; b15 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t29 array = makearray_dynamic_local size #{ a29 = #0l; b29 = (unbox_unit ()) } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t30 array = makearray_dynamic_local size #{ a30 = #0l; b30 = #{ a13 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t31 array = makearray_dynamic_local size #{ a31 = #0l; b31 = #{ a15 = #1l; b15 = #2l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t32 array = makearray_dynamic_local size #{ a32 = #0n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t34 array = makearray_dynamic_local size #{ a34 = #0n; b34 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t35 array = makearray_dynamic_local size #{ a35 = #0n; b35 = #1n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t36 array = makearray_dynamic_local size #{ a36 = #0n; b36 = (unbox_unit ()) } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t37 array = makearray_dynamic_local size #{ a37 = (unbox_unit ()) } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t38 array = makearray_dynamic_local size #{ a38 = (unbox_unit ()); b38 = 0 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t39 array = makearray_dynamic_local size #{ a39 = (unbox_unit ()); b39 = 0L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t40 array = makearray_dynamic_local size #{ a40 = (unbox_unit ()); b40 = #0L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t41 array = makearray_dynamic_local size #{ a41 = (unbox_unit ()); b41 = #0l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t42 array = makearray_dynamic_local size #{ a42 = (unbox_unit ()); b42 = #0n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t43 array = makearray_dynamic_local size #{ a43 = (unbox_unit ()); b43 = (unbox_unit ()) } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t44 array = makearray_dynamic_local size #{ a44 = #0. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t45 array = makearray_dynamic_local size #{ a45 = #0.; b45 = #1. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t46 array = makearray_dynamic_local size #{ a46 = #0.; b46 = #1.; c46 = #2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t47 array = makearray_dynamic_local size #{ a47 = #0.; b47 = #{ a44 = #1. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t48 array = makearray_dynamic_local size #{ a48 = #0.; b48 = #{ a45 = #1.; b45 = #2. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t49 array = makearray_dynamic_local size #{ a49 = #{ a0 = 0 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t50 array = makearray_dynamic_local size #{ a50 = #{ a0 = 0 }; b50 = 1 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t51 array = makearray_dynamic_local size #{ a51 = #{ a0 = 0 }; b51 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t52 array = makearray_dynamic_local size #{ a52 = #{ a1 = 0; b1 = 1 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t53 array = makearray_dynamic_local size #{ a53 = #{ a1 = 0; b1 = 1 }; b53 = 2 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t54 array = makearray_dynamic_local size #{ a54 = #{ a1 = 0; b1 = 1 }; b54 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t55 array = makearray_dynamic_local size #{ a55 = #{ a6 = 0; b6 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t57 array = makearray_dynamic_local size #{ a57 = #{ a13 = #0l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t58 array = makearray_dynamic_local size #{ a58 = #{ a13 = #0l }; b58 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t59 array = makearray_dynamic_local size #{ a59 = #{ a15 = #0l; b15 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t60 array = makearray_dynamic_local size #{ a60 = #{ a15 = #0l; b15 = #1l }; b60 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t61 array = makearray_dynamic_local size #{ a61 = #{ a44 = #0. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t62 array = makearray_dynamic_local size #{ a62 = #{ a44 = #0. }; b62 = #1. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t63 array = makearray_dynamic_local size #{ a63 = #{ a45 = #0.; b45 = #1. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t64 array = makearray_dynamic_local size #{ a64 = #{ a45 = #0.; b45 = #1. }; b64 = #2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
