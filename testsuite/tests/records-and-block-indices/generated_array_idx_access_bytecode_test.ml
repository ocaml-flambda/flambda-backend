...
let test size =
  ...
  (*   t18 = #{ int; #{ int32# } }   *)
  (***********************************)
  let eq = (fun #{ a18 = a181; b18 = b181 } #{ a18 = a182; b18 = b182 } -> (fun a b -> Int.equal a b) a181 a182 && (fun #{ a17 = a171 } #{ a17 = a172 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a171 a172) b181 b182) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b18.#a17) : (t18 array, _) idx_mut) next_el.#b18.#a17;
    mark_test_run 95;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t20 = #{ int; #{ int32#; int32# } }   *)
  (*******************************************)
  let eq = (fun #{ a20 = a201; b20 = b201 } #{ a20 = a202; b20 = b202 } -> (fun a b -> Int.equal a b) a201 a202 && (fun #{ a19 = a191; b19 = b191 } #{ a19 = a192; b19 = b192 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a191 a192 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b191 b192) b201 b202) in
  ...
  (*   t24 = #{ int; #{ float; int } }   *)
  (***************************************)
  let eq = (fun #{ a24 = a241; b24 = b241 } #{ a24 = a242; b24 = b242 } -> (fun a b -> Int.equal a b) a241 a242 && (fun #{ a23 = a231; b23 = b231 } #{ a23 = a232; b23 = b232 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a231 a232 && (fun a b -> Int.equal a b) b231 b232) b241 b242) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b24.#a23) : (t24 array, _) idx_mut) next_el.#b24.#a23;
    mark_test_run 111;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 111 failed %d %d" size i;
    (* Path: [.#b24.#b23] *)
    let el = #{ el with b24 = #{ el.#b24 with b23 = next_el.#b24.#b23 } } in
    Idx_mut.unsafe_set a ((.(i).#b24.#b23) : (t24 array, _) idx_mut) next_el.#b24.#b23;
    mark_test_run 112;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t26 = #{ int; #{ float; float } }   *)
  (*****************************************)
  let eq = (fun #{ a26 = a261; b26 = b261 } #{ a26 = a262; b26 = b262 } -> (fun a b -> Int.equal a b) a261 a262 && (fun #{ a25 = a251; b25 = b251 } #{ a25 = a252; b25 = b252 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a251 a252 && (fun a b -> Float.equal (globalize a) (globalize b)) b251 b252) b261 b262) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b26.#a25) : (t26 array, _) idx_mut) next_el.#b26.#a25;
    mark_test_run 117;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 117 failed %d %d" size i;
    (* Path: [.#b26.#b25] *)
    let el = #{ el with b26 = #{ el.#b26 with b25 = next_el.#b26.#b25 } } in
    Idx_mut.unsafe_set a ((.(i).#b26.#b25) : (t26 array, _) idx_mut) next_el.#b26.#b25;
    mark_test_run 118;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t27 = #{ int64 }   *)
  (************************)
  let eq = (fun #{ a27 = a271 } #{ a27 = a272 } -> (fun a b -> Int64.equal (globalize a) (globalize b)) a271 a272) in
  ...
  (*   t28 = #{ int64; int }   *)
  (*****************************)
  let eq = (fun #{ a28 = a281; b28 = b281 } #{ a28 = a282; b28 = b282 } -> (fun a b -> Int64.equal (globalize a) (globalize b)) a281 a282 && (fun a b -> Int.equal a b) b281 b282) in
  ...
  (*   t29 = #{ int64; int64 }   *)
  (*******************************)
  let eq = (fun #{ a29 = a291; b29 = b291 } #{ a29 = a292; b29 = b292 } -> (fun a b -> Int64.equal (globalize a) (globalize b)) a291 a292 && (fun a b -> Int64.equal (globalize a) (globalize b)) b291 b292) in
  ...
  (*   t30 = #{ int64; float }   *)
  (*******************************)
  let eq = (fun #{ a30 = a301; b30 = b301 } #{ a30 = a302; b30 = b302 } -> (fun a b -> Int64.equal (globalize a) (globalize b)) a301 a302 && (fun a b -> Float.equal (globalize a) (globalize b)) b301 b302) in
  ...
  (*   t31 = #{ int64# }   *)
  (*************************)
  let eq = (fun #{ a31 = a311 } #{ a31 = a312 } -> (fun a b -> Int64_u.(equal (add #0L a) (add #0L b))) a311 a312) in
  ...
  (*   t32 = #{ int64#; int64# }   *)
  (*********************************)
  let eq = (fun #{ a32 = a321; b32 = b321 } #{ a32 = a322; b32 = b322 } -> (fun a b -> Int64_u.(equal (add #0L a) (add #0L b))) a321 a322 && (fun a b -> Int64_u.(equal (add #0L a) (add #0L b))) b321 b322) in
  ...
  (*   t33 = #{ int64#; int32# }   *)
  (*********************************)
  let eq = (fun #{ a33 = a331; b33 = b331 } #{ a33 = a332; b33 = b332 } -> (fun a b -> Int64_u.(equal (add #0L a) (add #0L b))) a331 a332 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b331 b332) in
  ...
  (*   t34 = #{ int64#; nativeint# }   *)
  (*************************************)
  let eq = (fun #{ a34 = a341; b34 = b341 } #{ a34 = a342; b34 = b342 } -> (fun a b -> Int64_u.(equal (add #0L a) (add #0L b))) a341 a342 && (fun a b -> Nativeint_u.(equal (add #0n a) (add #0n b))) b341 b342) in
  ...
  (*   t17 = #{ int32# }   *)
  (*************************)
  let eq = (fun #{ a17 = a171 } #{ a17 = a172 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a171 a172) in
  ...
  (*   t35 = #{ int32#; int64# }   *)
  (*********************************)
  let eq = (fun #{ a35 = a351; b35 = b351 } #{ a35 = a352; b35 = b352 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a351 a352 && (fun a b -> Int64_u.(equal (add #0L a) (add #0L b))) b351 b352) in
  ...
  (*   t19 = #{ int32#; int32# }   *)
  (*********************************)
  let eq = (fun #{ a19 = a191; b19 = b191 } #{ a19 = a192; b19 = b192 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a191 a192 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b191 b192) in
  ...
  (*****************************************)
  let eq = (fun #{ a36 = a361; b36 = b361; c36 = c361 } #{ a36 = a362; b36 = b362; c36 = c362 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a361 a362 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b361 b362 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) c361 c362) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#c36) : (t36 array, _) idx_mut) next_el.#c36;
    mark_test_run 164;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t37 = #{ int32#; nativeint# }   *)
  (*************************************)
  let eq = (fun #{ a37 = a371; b37 = b371 } #{ a37 = a372; b37 = b372 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a371 a372 && (fun a b -> Nativeint_u.(equal (add #0n a) (add #0n b))) b371 b372) in
  ...
  (*   t38 = #{ int32#; #{ int32# } }   *)
  (**************************************)
  let eq = (fun #{ a38 = a381; b38 = b381 } #{ a38 = a382; b38 = b382 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a381 a382 && (fun #{ a17 = a171 } #{ a17 = a172 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a171 a172) b381 b382) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b38.#a17) : (t38 array, _) idx_mut) next_el.#b38.#a17;
    mark_test_run 173;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (**********************************************)
  let eq = (fun #{ a39 = a391; b39 = b391 } #{ a39 = a392; b39 = b392 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a391 a392 && (fun #{ a19 = a191; b19 = b191 } #{ a19 = a192; b19 = b192 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a191 a192 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b191 b192) b391 b392) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b39.#a19) : (t39 array, _) idx_mut) next_el.#b39.#a19;
    mark_test_run 178;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 178 failed %d %d" size i;
    (* Path: [.#b39.#b19] *)
    let el = #{ el with b39 = #{ el.#b39 with b19 = next_el.#b39.#b19 } } in
    Idx_mut.unsafe_set a ((.(i).#b39.#b19) : (t39 array, _) idx_mut) next_el.#b39.#b19;
    mark_test_run 179;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t40 = #{ nativeint# }   *)
  (*****************************)
  let eq = (fun #{ a40 = a401 } #{ a40 = a402 } -> (fun a b -> Nativeint_u.(equal (add #0n a) (add #0n b))) a401 a402) in
  ...
  (*   t41 = #{ nativeint#; int64# }   *)
  (*************************************)
  let eq = (fun #{ a41 = a411; b41 = b411 } #{ a41 = a412; b41 = b412 } -> (fun a b -> Nativeint_u.(equal (add #0n a) (add #0n b))) a411 a412 && (fun a b -> Int64_u.(equal (add #0L a) (add #0L b))) b411 b412) in
  ...
  (*   t42 = #{ nativeint#; int32# }   *)
  (*************************************)
  let eq = (fun #{ a42 = a421; b42 = b421 } #{ a42 = a422; b42 = b422 } -> (fun a b -> Nativeint_u.(equal (add #0n a) (add #0n b))) a421 a422 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b421 b422) in
  ...
  (*****************************************)
  let eq = (fun #{ a43 = a431; b43 = b431 } #{ a43 = a432; b43 = b432 } -> (fun a b -> Nativeint_u.(equal (add #0n a) (add #0n b))) a431 a432 && (fun a b -> Nativeint_u.(equal (add #0n a) (add #0n b))) b431 b432) in
  ...
  (*   t44 = #{ float; int; int }   *)
  (**********************************)
  let eq = (fun #{ a44 = a441; b44 = b441; c44 = c441 } #{ a44 = a442; b44 = b442; c44 = c442 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a441 a442 && (fun a b -> Int.equal a b) b441 b442 && (fun a b -> Int.equal a b) c441 c442) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#c44) : (t44 array, _) idx_mut) next_el.#c44;
    mark_test_run 203;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t45 = #{ float; int; float }   *)
  (************************************)
  let eq = (fun #{ a45 = a451; b45 = b451; c45 = c451 } #{ a45 = a452; b45 = b452; c45 = c452 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a451 a452 && (fun a b -> Int.equal a b) b451 b452 && (fun a b -> Float.equal (globalize a) (globalize b)) c451 c452) in
  ...
  (*   t46 = #{ float; int64 }   *)
  (*******************************)
  let eq = (fun #{ a46 = a461; b46 = b461 } #{ a46 = a462; b46 = b462 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a461 a462 && (fun a b -> Int64.equal (globalize a) (globalize b)) b461 b462) in
  ...
  (*   t47 = #{ float; float; int }   *)
  (************************************)
  let eq = (fun #{ a47 = a471; b47 = b471; c47 = c471 } #{ a47 = a472; b47 = b472; c47 = c472 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a471 a472 && (fun a b -> Float.equal (globalize a) (globalize b)) b471 b472 && (fun a b -> Int.equal a b) c471 c472) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#c47) : (t47 array, _) idx_mut) next_el.#c47;
    mark_test_run 221;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (**************************************)
  let eq = (fun #{ a48 = a481; b48 = b481; c48 = c481 } #{ a48 = a482; b48 = b482; c48 = c482 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a481 a482 && (fun a b -> Float.equal (globalize a) (globalize b)) b481 b482 && (fun a b -> Float.equal (globalize a) (globalize b)) c481 c482) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#c48) : (t48 array, _) idx_mut) next_el.#c48;
    mark_test_run 226;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t49 = #{ float; #{ int } }   *)
  (**********************************)
  let eq = (fun #{ a49 = a491; b49 = b491 } #{ a49 = a492; b49 = b492 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a491 a492 && (fun #{ a0 = a01 } #{ a0 = a02 } -> (fun a b -> Int.equal a b) a01 a02) b491 b492) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b49.#a0) : (t49 array, _) idx_mut) next_el.#b49.#a0;
    mark_test_run 231;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t50 = #{ float; #{ int; int } }   *)
  (***************************************)
  let eq = (fun #{ a50 = a501; b50 = b501 } #{ a50 = a502; b50 = b502 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a501 a502 && (fun #{ a1 = a11; b1 = b11 } #{ a1 = a12; b1 = b12 } -> (fun a b -> Int.equal a b) a11 a12 && (fun a b -> Int.equal a b) b11 b12) b501 b502) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b50.#a1) : (t50 array, _) idx_mut) next_el.#b50.#a1;
    mark_test_run 236;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 236 failed %d %d" size i;
    (* Path: [.#b50.#b1] *)
    let el = #{ el with b50 = #{ el.#b50 with b1 = next_el.#b50.#b1 } } in
    Idx_mut.unsafe_set a ((.(i).#b50.#b1) : (t50 array, _) idx_mut) next_el.#b50.#b1;
    mark_test_run 237;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t51 = #{ float; #{ int; float } }   *)
  (*****************************************)
  let eq = (fun #{ a51 = a511; b51 = b511 } #{ a51 = a512; b51 = b512 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a511 a512 && (fun #{ a10 = a101; b10 = b101 } #{ a10 = a102; b10 = b102 } -> (fun a b -> Int.equal a b) a101 a102 && (fun a b -> Float.equal (globalize a) (globalize b)) b101 b102) b511 b512) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b51.#a10) : (t51 array, _) idx_mut) next_el.#b51.#a10;
    mark_test_run 242;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 242 failed %d %d" size i;
    (* Path: [.#b51.#b10] *)
    let el = #{ el with b51 = #{ el.#b51 with b10 = next_el.#b51.#b10 } } in
    Idx_mut.unsafe_set a ((.(i).#b51.#b10) : (t51 array, _) idx_mut) next_el.#b51.#b10;
    mark_test_run 243;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t52 = #{ float; #{ float } }   *)
  (************************************)
  let eq = (fun #{ a52 = a521; b52 = b521 } #{ a52 = a522; b52 = b522 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a521 a522 && (fun #{ a21 = a211 } #{ a21 = a212 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a211 a212) b521 b522) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b52.#a21) : (t52 array, _) idx_mut) next_el.#b52.#a21;
    mark_test_run 248;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t53 = #{ float; #{ float; int } }   *)
  (*****************************************)
  let eq = (fun #{ a53 = a531; b53 = b531 } #{ a53 = a532; b53 = b532 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a531 a532 && (fun #{ a23 = a231; b23 = b231 } #{ a23 = a232; b23 = b232 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a231 a232 && (fun a b -> Int.equal a b) b231 b232) b531 b532) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b53.#a23) : (t53 array, _) idx_mut) next_el.#b53.#a23;
    mark_test_run 253;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 253 failed %d %d" size i;
    (* Path: [.#b53.#b23] *)
    let el = #{ el with b53 = #{ el.#b53 with b23 = next_el.#b53.#b23 } } in
    Idx_mut.unsafe_set a ((.(i).#b53.#b23) : (t53 array, _) idx_mut) next_el.#b53.#b23;
    mark_test_run 254;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*******************************************)
  let eq = (fun #{ a54 = a541; b54 = b541 } #{ a54 = a542; b54 = b542 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a541 a542 && (fun #{ a25 = a251; b25 = b251 } #{ a25 = a252; b25 = b252 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a251 a252 && (fun a b -> Float.equal (globalize a) (globalize b)) b251 b252) b541 b542) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#b54.#a25) : (t54 array, _) idx_mut) next_el.#b54.#a25;
    mark_test_run 259;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 259 failed %d %d" size i;
    (* Path: [.#b54.#b25] *)
    let el = #{ el with b54 = #{ el.#b54 with b25 = next_el.#b54.#b25 } } in
    Idx_mut.unsafe_set a ((.(i).#b54.#b25) : (t54 array, _) idx_mut) next_el.#b54.#b25;
    mark_test_run 260;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t55 = #{ #{ int } }   *)
  (***************************)
  let eq = (fun #{ a55 = a551 } #{ a55 = a552 } -> (fun #{ a0 = a01 } #{ a0 = a02 } -> (fun a b -> Int.equal a b) a01 a02) a551 a552) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a55.#a0) : (t55 array, _) idx_mut) next_el.#a55.#a0;
    mark_test_run 264;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t56 = #{ #{ int }; int }   *)
  (********************************)
  let eq = (fun #{ a56 = a561; b56 = b561 } #{ a56 = a562; b56 = b562 } -> (fun #{ a0 = a01 } #{ a0 = a02 } -> (fun a b -> Int.equal a b) a01 a02) a561 a562 && (fun a b -> Int.equal a b) b561 b562) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a56.#a0) : (t56 array, _) idx_mut) next_el.#a56.#a0;
    mark_test_run 269;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t57 = #{ #{ int }; int32# }   *)
  (***********************************)
  let eq = (fun #{ a57 = a571; b57 = b571 } #{ a57 = a572; b57 = b572 } -> (fun #{ a0 = a01 } #{ a0 = a02 } -> (fun a b -> Int.equal a b) a01 a02) a571 a572 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b571 b572) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a57.#a0) : (t57 array, _) idx_mut) next_el.#a57.#a0;
    mark_test_run 274;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t58 = #{ #{ int }; float }   *)
  (**********************************)
  let eq = (fun #{ a58 = a581; b58 = b581 } #{ a58 = a582; b58 = b582 } -> (fun #{ a0 = a01 } #{ a0 = a02 } -> (fun a b -> Int.equal a b) a01 a02) a581 a582 && (fun a b -> Float.equal (globalize a) (globalize b)) b581 b582) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a58.#a0) : (t58 array, _) idx_mut) next_el.#a58.#a0;
    mark_test_run 279;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t59 = #{ #{ int; int } }   *)
  (********************************)
  let eq = (fun #{ a59 = a591 } #{ a59 = a592 } -> (fun #{ a1 = a11; b1 = b11 } #{ a1 = a12; b1 = b12 } -> (fun a b -> Int.equal a b) a11 a12 && (fun a b -> Int.equal a b) b11 b12) a591 a592) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a59.#a1) : (t59 array, _) idx_mut) next_el.#a59.#a1;
    mark_test_run 283;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 283 failed %d %d" size i;
    (* Path: [.#a59.#b1] *)
    let el = #{ el with a59 = #{ el.#a59 with b1 = next_el.#a59.#b1 } } in
    Idx_mut.unsafe_set a ((.(i).#a59.#b1) : (t59 array, _) idx_mut) next_el.#a59.#b1;
    mark_test_run 284;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t60 = #{ #{ int; int }; int }   *)
  (*************************************)
  let eq = (fun #{ a60 = a601; b60 = b601 } #{ a60 = a602; b60 = b602 } -> (fun #{ a1 = a11; b1 = b11 } #{ a1 = a12; b1 = b12 } -> (fun a b -> Int.equal a b) a11 a12 && (fun a b -> Int.equal a b) b11 b12) a601 a602 && (fun a b -> Int.equal a b) b601 b602) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a60.#a1) : (t60 array, _) idx_mut) next_el.#a60.#a1;
    mark_test_run 289;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 289 failed %d %d" size i;
    (* Path: [.#a60.#b1] *)
    let el = #{ el with a60 = #{ el.#a60 with b1 = next_el.#a60.#b1 } } in
    Idx_mut.unsafe_set a ((.(i).#a60.#b1) : (t60 array, _) idx_mut) next_el.#a60.#b1;
    mark_test_run 290;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t61 = #{ #{ int; int }; int32# }   *)
  (****************************************)
  let eq = (fun #{ a61 = a611; b61 = b611 } #{ a61 = a612; b61 = b612 } -> (fun #{ a1 = a11; b1 = b11 } #{ a1 = a12; b1 = b12 } -> (fun a b -> Int.equal a b) a11 a12 && (fun a b -> Int.equal a b) b11 b12) a611 a612 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b611 b612) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a61.#a1) : (t61 array, _) idx_mut) next_el.#a61.#a1;
    mark_test_run 295;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 295 failed %d %d" size i;
    (* Path: [.#a61.#b1] *)
    let el = #{ el with a61 = #{ el.#a61 with b1 = next_el.#a61.#b1 } } in
    Idx_mut.unsafe_set a ((.(i).#a61.#b1) : (t61 array, _) idx_mut) next_el.#a61.#b1;
    mark_test_run 296;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t62 = #{ #{ int; int }; float }   *)
  (***************************************)
  let eq = (fun #{ a62 = a621; b62 = b621 } #{ a62 = a622; b62 = b622 } -> (fun #{ a1 = a11; b1 = b11 } #{ a1 = a12; b1 = b12 } -> (fun a b -> Int.equal a b) a11 a12 && (fun a b -> Int.equal a b) b11 b12) a621 a622 && (fun a b -> Float.equal (globalize a) (globalize b)) b621 b622) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a62.#a1) : (t62 array, _) idx_mut) next_el.#a62.#a1;
    mark_test_run 301;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 301 failed %d %d" size i;
    (* Path: [.#a62.#b1] *)
    let el = #{ el with a62 = #{ el.#a62 with b1 = next_el.#a62.#b1 } } in
    Idx_mut.unsafe_set a ((.(i).#a62.#b1) : (t62 array, _) idx_mut) next_el.#a62.#b1;
    mark_test_run 302;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t63 = #{ #{ int; int32# } }   *)
  (***********************************)
  let eq = (fun #{ a63 = a631 } #{ a63 = a632 } -> (fun #{ a7 = a71; b7 = b71 } #{ a7 = a72; b7 = b72 } -> (fun a b -> Int.equal a b) a71 a72 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b71 b72) a631 a632) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a63.#a7) : (t63 array, _) idx_mut) next_el.#a63.#a7;
    mark_test_run 306;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 306 failed %d %d" size i;
    (* Path: [.#a63.#b7] *)
    let el = #{ el with a63 = #{ el.#a63 with b7 = next_el.#a63.#b7 } } in
    Idx_mut.unsafe_set a ((.(i).#a63.#b7) : (t63 array, _) idx_mut) next_el.#a63.#b7;
    mark_test_run 307;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t64 = #{ #{ int; int32# }; int32# }   *)
  (*******************************************)
  let eq = (fun #{ a64 = a641; b64 = b641 } #{ a64 = a642; b64 = b642 } -> (fun #{ a7 = a71; b7 = b71 } #{ a7 = a72; b7 = b72 } -> (fun a b -> Int.equal a b) a71 a72 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b71 b72) a641 a642 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b641 b642) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a64.#a7) : (t64 array, _) idx_mut) next_el.#a64.#a7;
    mark_test_run 312;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 312 failed %d %d" size i;
    (* Path: [.#a64.#b7] *)
    let el = #{ el with a64 = #{ el.#a64 with b7 = next_el.#a64.#b7 } } in
    Idx_mut.unsafe_set a ((.(i).#a64.#b7) : (t64 array, _) idx_mut) next_el.#a64.#b7;
    mark_test_run 313;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t65 = #{ #{ int; float } }   *)
  (**********************************)
  let eq = (fun #{ a65 = a651 } #{ a65 = a652 } -> (fun #{ a10 = a101; b10 = b101 } #{ a10 = a102; b10 = b102 } -> (fun a b -> Int.equal a b) a101 a102 && (fun a b -> Float.equal (globalize a) (globalize b)) b101 b102) a651 a652) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a65.#a10) : (t65 array, _) idx_mut) next_el.#a65.#a10;
    mark_test_run 317;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 317 failed %d %d" size i;
    (* Path: [.#a65.#b10] *)
    let el = #{ el with a65 = #{ el.#a65 with b10 = next_el.#a65.#b10 } } in
    Idx_mut.unsafe_set a ((.(i).#a65.#b10) : (t65 array, _) idx_mut) next_el.#a65.#b10;
    mark_test_run 318;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t66 = #{ #{ int; float }; int }   *)
  (***************************************)
  let eq = (fun #{ a66 = a661; b66 = b661 } #{ a66 = a662; b66 = b662 } -> (fun #{ a10 = a101; b10 = b101 } #{ a10 = a102; b10 = b102 } -> (fun a b -> Int.equal a b) a101 a102 && (fun a b -> Float.equal (globalize a) (globalize b)) b101 b102) a661 a662 && (fun a b -> Int.equal a b) b661 b662) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a66.#a10) : (t66 array, _) idx_mut) next_el.#a66.#a10;
    mark_test_run 323;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 323 failed %d %d" size i;
    (* Path: [.#a66.#b10] *)
    let el = #{ el with a66 = #{ el.#a66 with b10 = next_el.#a66.#b10 } } in
    Idx_mut.unsafe_set a ((.(i).#a66.#b10) : (t66 array, _) idx_mut) next_el.#a66.#b10;
    mark_test_run 324;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t67 = #{ #{ int; float }; float }   *)
  (*****************************************)
  let eq = (fun #{ a67 = a671; b67 = b671 } #{ a67 = a672; b67 = b672 } -> (fun #{ a10 = a101; b10 = b101 } #{ a10 = a102; b10 = b102 } -> (fun a b -> Int.equal a b) a101 a102 && (fun a b -> Float.equal (globalize a) (globalize b)) b101 b102) a671 a672 && (fun a b -> Float.equal (globalize a) (globalize b)) b671 b672) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a67.#a10) : (t67 array, _) idx_mut) next_el.#a67.#a10;
    mark_test_run 329;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 329 failed %d %d" size i;
    (* Path: [.#a67.#b10] *)
    let el = #{ el with a67 = #{ el.#a67 with b10 = next_el.#a67.#b10 } } in
    Idx_mut.unsafe_set a ((.(i).#a67.#b10) : (t67 array, _) idx_mut) next_el.#a67.#b10;
    mark_test_run 330;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t68 = #{ #{ int32# } }   *)
  (******************************)
  let eq = (fun #{ a68 = a681 } #{ a68 = a682 } -> (fun #{ a17 = a171 } #{ a17 = a172 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a171 a172) a681 a682) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a68.#a17) : (t68 array, _) idx_mut) next_el.#a68.#a17;
    mark_test_run 334;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t69 = #{ #{ int32# }; int32# }   *)
  (**************************************)
  let eq = (fun #{ a69 = a691; b69 = b691 } #{ a69 = a692; b69 = b692 } -> (fun #{ a17 = a171 } #{ a17 = a172 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a171 a172) a691 a692 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b691 b692) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a69.#a17) : (t69 array, _) idx_mut) next_el.#a69.#a17;
    mark_test_run 339;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t70 = #{ #{ int32#; int32# } }   *)
  (**************************************)
  let eq = (fun #{ a70 = a701 } #{ a70 = a702 } -> (fun #{ a19 = a191; b19 = b191 } #{ a19 = a192; b19 = b192 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a191 a192 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b191 b192) a701 a702) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a70.#a19) : (t70 array, _) idx_mut) next_el.#a70.#a19;
    mark_test_run 343;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 343 failed %d %d" size i;
    (* Path: [.#a70.#b19] *)
    let el = #{ el with a70 = #{ el.#a70 with b19 = next_el.#a70.#b19 } } in
    Idx_mut.unsafe_set a ((.(i).#a70.#b19) : (t70 array, _) idx_mut) next_el.#a70.#b19;
    mark_test_run 344;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (**********************************************)
  let eq = (fun #{ a71 = a711; b71 = b711 } #{ a71 = a712; b71 = b712 } -> (fun #{ a19 = a191; b19 = b191 } #{ a19 = a192; b19 = b192 } -> (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) a191 a192 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b191 b192) a711 a712 && (fun a b -> Int32_u.(equal (add #0l a) (add #0l b))) b711 b712) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a71.#a19) : (t71 array, _) idx_mut) next_el.#a71.#a19;
    mark_test_run 349;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 349 failed %d %d" size i;
    (* Path: [.#a71.#b19] *)
    let el = #{ el with a71 = #{ el.#a71 with b19 = next_el.#a71.#b19 } } in
    Idx_mut.unsafe_set a ((.(i).#a71.#b19) : (t71 array, _) idx_mut) next_el.#a71.#b19;
    mark_test_run 350;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t72 = #{ #{ float }; int }   *)
  (**********************************)
  let eq = (fun #{ a72 = a721; b72 = b721 } #{ a72 = a722; b72 = b722 } -> (fun #{ a21 = a211 } #{ a21 = a212 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a211 a212) a721 a722 && (fun a b -> Int.equal a b) b721 b722) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a72.#a21) : (t72 array, _) idx_mut) next_el.#a72.#a21;
    mark_test_run 355;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t73 = #{ #{ float }; float }   *)
  (************************************)
  let eq = (fun #{ a73 = a731; b73 = b731 } #{ a73 = a732; b73 = b732 } -> (fun #{ a21 = a211 } #{ a21 = a212 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a211 a212) a731 a732 && (fun a b -> Float.equal (globalize a) (globalize b)) b731 b732) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a73.#a21) : (t73 array, _) idx_mut) next_el.#a73.#a21;
    mark_test_run 360;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t74 = #{ #{ float; int } }   *)
  (**********************************)
  let eq = (fun #{ a74 = a741 } #{ a74 = a742 } -> (fun #{ a23 = a231; b23 = b231 } #{ a23 = a232; b23 = b232 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a231 a232 && (fun a b -> Int.equal a b) b231 b232) a741 a742) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a74.#a23) : (t74 array, _) idx_mut) next_el.#a74.#a23;
    mark_test_run 364;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 364 failed %d %d" size i;
    (* Path: [.#a74.#b23] *)
    let el = #{ el with a74 = #{ el.#a74 with b23 = next_el.#a74.#b23 } } in
    Idx_mut.unsafe_set a ((.(i).#a74.#b23) : (t74 array, _) idx_mut) next_el.#a74.#b23;
    mark_test_run 365;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t75 = #{ #{ float; int }; int }   *)
  (***************************************)
  let eq = (fun #{ a75 = a751; b75 = b751 } #{ a75 = a752; b75 = b752 } -> (fun #{ a23 = a231; b23 = b231 } #{ a23 = a232; b23 = b232 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a231 a232 && (fun a b -> Int.equal a b) b231 b232) a751 a752 && (fun a b -> Int.equal a b) b751 b752) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a75.#a23) : (t75 array, _) idx_mut) next_el.#a75.#a23;
    mark_test_run 370;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 370 failed %d %d" size i;
    (* Path: [.#a75.#b23] *)
    let el = #{ el with a75 = #{ el.#a75 with b23 = next_el.#a75.#b23 } } in
    Idx_mut.unsafe_set a ((.(i).#a75.#b23) : (t75 array, _) idx_mut) next_el.#a75.#b23;
    mark_test_run 371;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t76 = #{ #{ float; int }; float }   *)
  (*****************************************)
  let eq = (fun #{ a76 = a761; b76 = b761 } #{ a76 = a762; b76 = b762 } -> (fun #{ a23 = a231; b23 = b231 } #{ a23 = a232; b23 = b232 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a231 a232 && (fun a b -> Int.equal a b) b231 b232) a761 a762 && (fun a b -> Float.equal (globalize a) (globalize b)) b761 b762) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a76.#a23) : (t76 array, _) idx_mut) next_el.#a76.#a23;
    mark_test_run 376;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 376 failed %d %d" size i;
    (* Path: [.#a76.#b23] *)
    let el = #{ el with a76 = #{ el.#a76 with b23 = next_el.#a76.#b23 } } in
    Idx_mut.unsafe_set a ((.(i).#a76.#b23) : (t76 array, _) idx_mut) next_el.#a76.#b23;
    mark_test_run 377;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t77 = #{ #{ float; float } }   *)
  (************************************)
  let eq = (fun #{ a77 = a771 } #{ a77 = a772 } -> (fun #{ a25 = a251; b25 = b251 } #{ a25 = a252; b25 = b252 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a251 a252 && (fun a b -> Float.equal (globalize a) (globalize b)) b251 b252) a771 a772) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a77.#a25) : (t77 array, _) idx_mut) next_el.#a77.#a25;
    mark_test_run 381;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 381 failed %d %d" size i;
    (* Path: [.#a77.#b25] *)
    let el = #{ el with a77 = #{ el.#a77 with b25 = next_el.#a77.#b25 } } in
    Idx_mut.unsafe_set a ((.(i).#a77.#b25) : (t77 array, _) idx_mut) next_el.#a77.#b25;
    mark_test_run 382;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*   t78 = #{ #{ float; float }; int }   *)
  (*****************************************)
  let eq = (fun #{ a78 = a781; b78 = b781 } #{ a78 = a782; b78 = b782 } -> (fun #{ a25 = a251; b25 = b251 } #{ a25 = a252; b25 = b252 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a251 a252 && (fun a b -> Float.equal (globalize a) (globalize b)) b251 b252) a781 a782 && (fun a b -> Int.equal a b) b781 b782) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a78.#a25) : (t78 array, _) idx_mut) next_el.#a78.#a25;
    mark_test_run 387;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 387 failed %d %d" size i;
    (* Path: [.#a78.#b25] *)
    let el = #{ el with a78 = #{ el.#a78 with b25 = next_el.#a78.#b25 } } in
    Idx_mut.unsafe_set a ((.(i).#a78.#b25) : (t78 array, _) idx_mut) next_el.#a78.#b25;
    mark_test_run 388;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
  ...
  (*******************************************)
  let eq = (fun #{ a79 = a791; b79 = b791 } #{ a79 = a792; b79 = b792 } -> (fun #{ a25 = a251; b25 = b251 } #{ a25 = a252; b25 = b252 } -> (fun a b -> Float.equal (globalize a) (globalize b)) a251 a252 && (fun a b -> Float.equal (globalize a) (globalize b)) b251 b252) a791 a792 && (fun a b -> Float.equal (globalize a) (globalize b)) b791 b792) in
  ...
  for i = 0 to size - 1 do
    ...
    Idx_mut.unsafe_set a ((.(i).#a79.#a25) : (t79 array, _) idx_mut) next_el.#a79.#a25;
    mark_test_run 393;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
    if not test then failwithf "test 393 failed %d %d" size i;
    (* Path: [.#a79.#b25] *)
    let el = #{ el with a79 = #{ el.#a79 with b25 = next_el.#a79.#b25 } } in
    Idx_mut.unsafe_set a ((.(i).#a79.#b25) : (t79 array, _) idx_mut) next_el.#a79.#b25;
    mark_test_run 394;
    let test = eq (Idx_mut.unsafe_get a (.(i))) el in
