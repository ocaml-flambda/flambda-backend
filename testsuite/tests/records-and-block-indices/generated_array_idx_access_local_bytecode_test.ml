...
let test size =
  ...
  (* Create an array of size [size] *)
  let a : t18 array = makearray_dynamic_local size #{ a18 = 0; b18 = #{ a17 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t20 array = makearray_dynamic_local size #{ a20 = 0; b20 = #{ a19 = #1l; b19 = #2l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t24 array = makearray_dynamic_local size #{ a24 = 0; b24 = #{ a23 = 1.; b23 = 2 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t26 array = makearray_dynamic_local size #{ a26 = 0; b26 = #{ a25 = 1.; b25 = 2. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t27 array = makearray_dynamic_local size #{ a27 = 0L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t28 array = makearray_dynamic_local size #{ a28 = 0L; b28 = 1 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t29 array = makearray_dynamic_local size #{ a29 = 0L; b29 = 1L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t30 array = makearray_dynamic_local size #{ a30 = 0L; b30 = 1. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t31 array = makearray_dynamic_local size #{ a31 = #0L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t32 array = makearray_dynamic_local size #{ a32 = #0L; b32 = #1L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t34 array = makearray_dynamic_local size #{ a34 = #0L; b34 = #1n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t17 array = makearray_dynamic_local size #{ a17 = #0l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t35 array = makearray_dynamic_local size #{ a35 = #0l; b35 = #1L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t19 array = makearray_dynamic_local size #{ a19 = #0l; b19 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t36 array = makearray_dynamic_local size #{ a36 = #0l; b36 = #1l; c36 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t37 array = makearray_dynamic_local size #{ a37 = #0l; b37 = #1n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t38 array = makearray_dynamic_local size #{ a38 = #0l; b38 = #{ a17 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t39 array = makearray_dynamic_local size #{ a39 = #0l; b39 = #{ a19 = #1l; b19 = #2l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t40 array = makearray_dynamic_local size #{ a40 = #0n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t42 array = makearray_dynamic_local size #{ a42 = #0n; b42 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t43 array = makearray_dynamic_local size #{ a43 = #0n; b43 = #1n } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t23 array = makearray_dynamic_local size #{ a23 = 0.; b23 = 1 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t44 array = makearray_dynamic_local size #{ a44 = 0.; b44 = 1; c44 = 2 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t46 array = makearray_dynamic_local size #{ a46 = 0.; b46 = 1L } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t25 array = makearray_dynamic_local size #{ a25 = 0.; b25 = 1. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t47 array = makearray_dynamic_local size #{ a47 = 0.; b47 = 1.; c47 = 2 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t48 array = makearray_dynamic_local size #{ a48 = 0.; b48 = 1.; c48 = 2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t49 array = makearray_dynamic_local size #{ a49 = 0.; b49 = #{ a0 = 1 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t50 array = makearray_dynamic_local size #{ a50 = 0.; b50 = #{ a1 = 1; b1 = 2 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t51 array = makearray_dynamic_local size #{ a51 = 0.; b51 = #{ a10 = 1; b10 = 2. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t52 array = makearray_dynamic_local size #{ a52 = 0.; b52 = #{ a21 = 1. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t53 array = makearray_dynamic_local size #{ a53 = 0.; b53 = #{ a23 = 1.; b23 = 2 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t54 array = makearray_dynamic_local size #{ a54 = 0.; b54 = #{ a25 = 1.; b25 = 2. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t55 array = makearray_dynamic_local size #{ a55 = #{ a0 = 0 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t56 array = makearray_dynamic_local size #{ a56 = #{ a0 = 0 }; b56 = 1 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t57 array = makearray_dynamic_local size #{ a57 = #{ a0 = 0 }; b57 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t58 array = makearray_dynamic_local size #{ a58 = #{ a0 = 0 }; b58 = 1. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t59 array = makearray_dynamic_local size #{ a59 = #{ a1 = 0; b1 = 1 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t60 array = makearray_dynamic_local size #{ a60 = #{ a1 = 0; b1 = 1 }; b60 = 2 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t61 array = makearray_dynamic_local size #{ a61 = #{ a1 = 0; b1 = 1 }; b61 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t62 array = makearray_dynamic_local size #{ a62 = #{ a1 = 0; b1 = 1 }; b62 = 2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t63 array = makearray_dynamic_local size #{ a63 = #{ a7 = 0; b7 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t64 array = makearray_dynamic_local size #{ a64 = #{ a7 = 0; b7 = #1l }; b64 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t65 array = makearray_dynamic_local size #{ a65 = #{ a10 = 0; b10 = 1. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t66 array = makearray_dynamic_local size #{ a66 = #{ a10 = 0; b10 = 1. }; b66 = 2 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t67 array = makearray_dynamic_local size #{ a67 = #{ a10 = 0; b10 = 1. }; b67 = 2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t68 array = makearray_dynamic_local size #{ a68 = #{ a17 = #0l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t69 array = makearray_dynamic_local size #{ a69 = #{ a17 = #0l }; b69 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t70 array = makearray_dynamic_local size #{ a70 = #{ a19 = #0l; b19 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t71 array = makearray_dynamic_local size #{ a71 = #{ a19 = #0l; b19 = #1l }; b71 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t72 array = makearray_dynamic_local size #{ a72 = #{ a21 = 0. }; b72 = 1 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t73 array = makearray_dynamic_local size #{ a73 = #{ a21 = 0. }; b73 = 1. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t74 array = makearray_dynamic_local size #{ a74 = #{ a23 = 0.; b23 = 1 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t75 array = makearray_dynamic_local size #{ a75 = #{ a23 = 0.; b23 = 1 }; b75 = 2 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t76 array = makearray_dynamic_local size #{ a76 = #{ a23 = 0.; b23 = 1 }; b76 = 2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t77 array = makearray_dynamic_local size #{ a77 = #{ a25 = 0.; b25 = 1. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t78 array = makearray_dynamic_local size #{ a78 = #{ a25 = 0.; b25 = 1. }; b78 = 2 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t79 array = makearray_dynamic_local size #{ a79 = #{ a25 = 0.; b25 = 1. }; b79 = 2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    set_idx_mut a (.(i)) (mk_value i);
  done;
