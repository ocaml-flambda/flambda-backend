...
let test size =
  ...
  (* Create an array of size [size] *)
  let a : t37 array = makearray_dynamic size #{ a37 = (interleave_low_64 (int64x2_of_int64 0L) (int64x2_of_int64 1L)) } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t38 array = makearray_dynamic size #{ a38 = #{ a0 = 0 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t39 array = makearray_dynamic size #{ a39 = #{ a0 = 0 }; b39 = 1 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t40 array = makearray_dynamic size #{ a40 = #{ a0 = 0 }; b40 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t41 array = makearray_dynamic size #{ a41 = #{ a1 = 0; b1 = 1 } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t42 array = makearray_dynamic size #{ a42 = #{ a1 = 0; b1 = 1 }; b42 = 2 } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t43 array = makearray_dynamic size #{ a43 = #{ a1 = 0; b1 = 1 }; b43 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t44 array = makearray_dynamic size #{ a44 = #{ a6 = 0; b6 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t45 array = makearray_dynamic size #{ a45 = #{ a6 = 0; b6 = #1l }; b45 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t46 array = makearray_dynamic size #{ a46 = #{ a12 = #0l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t47 array = makearray_dynamic size #{ a47 = #{ a12 = #0l }; b47 = #1l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t48 array = makearray_dynamic size #{ a48 = #{ a14 = #0l; b14 = #1l } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t49 array = makearray_dynamic size #{ a49 = #{ a14 = #0l; b14 = #1l }; b49 = #2l } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t50 array = makearray_dynamic size #{ a50 = #{ a32 = #0. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t51 array = makearray_dynamic size #{ a51 = #{ a32 = #0. }; b51 = #1. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t52 array = makearray_dynamic size #{ a52 = #{ a33 = #0.; b33 = #1. } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t53 array = makearray_dynamic size #{ a53 = #{ a33 = #0.; b33 = #1. }; b53 = #2. } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
  ...
  (* Create an array of size [size] *)
  let a : t54 array = makearray_dynamic size #{ a54 = #{ a37 = (interleave_low_64 (int64x2_of_int64 0L) (int64x2_of_int64 1L)) } } in
  (* Fill [a] with distinct values using block indices *)
  for i = 0 to size - 1 do
    Idx_mut.unsafe_set a (.(i)) (mk_value i);
  done;
