...
[%%expect{|
val use_global : 'a -> unit @@ global many = <fun>
val use_global_product : ('a : value & value). 'a -> unit @@ global many =
  <fun>
val use_local : local_ 'a -> unit @@ global many = <fun>
val use_local_product : ('a : value & value). local_ 'a -> unit @@ global
  many = <fun>
|}]
...
[%%expect{|
val f : 'a -> local_ 'b -> unit @@ global many = <fun>
|}]
...
let f e0 (e1 @ local) =
    ...
    | x -> use_local x; ()
[%%expect{|
val f : 'a -> local_ 'a -> unit @@ global many = <fun>
|}]
...
[%%expect{|
val f : 'a -> local_ 'a -> local_ 'a @@ global many = <fun>
|}]
...
let f b e0 (e1 @ local) e2 e3 =
    ...
    | x0, x1 -> use_global x0; use_local x1; ()
[%%expect{|
val f : bool -> 'a -> local_ 'b -> 'a -> 'b -> unit @@ global many = <fun>
|}]
...
let f_unboxed_tuple (local_ a) (local_ b) =
  ...
  a'
[%%expect{|
val f_unboxed_tuple : local_ 'a -> local_ 'b -> local_ 'a @@ global many =
  <fun>
|}]
