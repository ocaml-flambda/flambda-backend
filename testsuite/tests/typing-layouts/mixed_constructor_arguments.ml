...
(* Now that the compiler re-orders things for you, the below also typechecks
   (the order doesn't matter, but the floats still aren't flat). *)
type t_cstr_boxed_float_reordered = A of float# * float

[%%expect{|
type t_cstr_boxed_float_reordered = A of float# * float
|}];;

type t_cstr_boxed_float_reordered_record = A of { x : float#; y : float }
...
(* Now that the compiler re-orders things for you, the below also typechecks
   (the order doesn't matter, but the floats still aren't flat). *)
type t_cstr_boxed_float_reordered_multi_constr =
  | Const
  | A of float# * float

[%%expect{|
type t_cstr_boxed_float_reordered_multi_constr = Const | A of float# * float
|}];;

type t_cstr_boxed_float_reordered_multi_constr_record =
  | Const
...
(* But the extensible variant case shows that you can't trick the type-checker
   by adding more constructors *)
type t_ext +=
  | Const
  | A of float# * float
...
type t_cstr_flat_string_reordered1 = A of float# * string

[%%expect{|
type t_cstr_flat_string_reordered1 = A of float# * string
|}];;

type t_cstr_flat_string_record_reordered1 = A of { x : float#; y : string }
...
type t_cstr_flat_string_reordered2 = A of float# * float# * string

[%%expect{|
type t_cstr_flat_string_reordered2 = A of float# * float# * string
|}];;

type t_cstr_flat_string_record_reordered2 = A of { x : float#; y : float#; z : string }

[%%expect{|
type t_cstr_flat_string_record_reordered2 =
...
(* The int [c] is moved to the prefix. *)
...
type 'a t_cstr_reordered_value_after_float = C of float# * 'a

[%%expect{|
type 'a t_cstr_reordered_value_after_float = C of float# * 'a
|}];;

type 'a t_cstr_reordered_value_after_float_record = C of { x : float#; y : 'a }

[%%expect{|
type 'a t_cstr_reordered_value_after_float_record =
    C of { x : float#; y : 'a; }
|}];;

(* Even values with external mode are reordered into the flat prefix, so that
   the ordering is consistent if we weaken the kind. *)
...
type t_cstr_capped_record_reordered = A of {
 unboxed:float#;
 a0:ptr; a1:ptr; a2:ptr; a3:ptr; a4:ptr; a5:ptr; a6:ptr; a7:ptr; a8:ptr; a9:ptr;
 b0:ptr; b1:ptr; b2:ptr; b3:ptr; b4:ptr; b5:ptr; b6:ptr; b7:ptr; b8:ptr; b9:ptr;
 c0:ptr; c1:ptr; c2:ptr; c3:ptr; c4:ptr; c5:ptr; c6:ptr; c7:ptr; c8:ptr; c9:ptr;
...
[%%expect{|
Lines 1-29, characters 38-2:
 1 | ......................................A of {
 2 |  unboxed:float#;
 3 |  a0:ptr; a1:ptr; a2:ptr; a3:ptr; a4:ptr; a5:ptr; a6:ptr; a7:ptr; a8:ptr; a9:ptr;
 4 |  b0:ptr; b1:ptr; b2:ptr; b3:ptr; b4:ptr; b5:ptr; b6:ptr; b7:ptr; b8:ptr; b9:ptr;
 5 |  c0:ptr; c1:ptr; c2:ptr; c3:ptr; c4:ptr; c5:ptr; c6:ptr; c7:ptr; c8:ptr; c9:ptr;
...
26 |  x0:ptr; x1:ptr; x2:ptr; x3:ptr; x4:ptr; x5:ptr; x6:ptr; x7:ptr; x8:ptr; x9:ptr;
27 |  y0:ptr; y1:ptr; y2:ptr; y3:ptr; y4:ptr; y5:ptr; y6:ptr; y7:ptr; y8:ptr; y9:ptr;
28 |  z0:ptr; z1:ptr; z2:ptr; z3:ptr; z4:ptr;
29 |  }
Error: Mixed inline record arguments to constructors may contain at most 254 value fields prior to the flat suffix, but this one contains 255.
|}]
