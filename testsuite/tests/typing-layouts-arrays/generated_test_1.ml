    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 86;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 86 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 88;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 88 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 94;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 94 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 96;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 96 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 115;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 115 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 122;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 122 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 124;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 124 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 129;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 129 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 130;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 130 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 131;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 131 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 136;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 136 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 137;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 137 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 138;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 138 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
