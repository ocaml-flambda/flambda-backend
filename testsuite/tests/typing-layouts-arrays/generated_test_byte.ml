...
let test_makearray_dynamic size =
  ...
  let a : float32# array = makearray_dynamic size (Sys.opaque_identity #0.s) in
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    let raises =
      match set a i (Sys.opaque_identity #0.s) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 82;
  ...
  iter (blit_offsets size) ~f:(fun ofs1 ->
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (Sys.opaque_identity (mk_value i));
        done;
      ) [@nontail];
    ) [@nontail];
  ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #0.s )in
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #0.s) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = Float_u.of_int i in
  (* 1. Create an array of size [size] *)
  let a : float# array = makearray_dynamic size (Sys.opaque_identity #0.) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 87;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #0.) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 90;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #0. )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #0.) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = Int32_u.of_int i in
  (* 1. Create an array of size [size] *)
  let a : int32# array = makearray_dynamic size (Sys.opaque_identity #0l) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 95;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #0l) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 98;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #0l )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #0l) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = Int64_u.of_int i in
  (* 1. Create an array of size [size] *)
  let a : int64# array = makearray_dynamic size (Sys.opaque_identity #0L) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 103;
  ...
  let mk_value i = Nativeint_u.of_int i in
  (* 1. Create an array of size [size] *)
  let a : nativeint# array = makearray_dynamic size (Sys.opaque_identity #0n) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 111;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #0n) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 114;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #0n )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #0n) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = (#{ a = Int64_u.of_int i; b = Float_u.of_int i } : ur1) in
  (* 1. Create an array of size [size] *)
  let a : ur1 array = makearray_dynamic size (Sys.opaque_identity (#{ a = #0L; b = #0. } : ur1)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 119;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity (#{ a = #0L; b = #0. } : ur1)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 122;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity (#{ a = #0L; b = #0. } : ur1) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity (#{ a = #0L; b = #0. } : ur1)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = (#{ a = Int64_u.of_int i } : ur3) in
  (* 1. Create an array of size [size] *)
  let a : ur3 array = makearray_dynamic size (Sys.opaque_identity (#{ a = #0L } : ur3)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 127;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity (#{ a = #0L } : ur3)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 130;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity (#{ a = #0L } : ur3) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity (#{ a = #0L } : ur3)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = (#{ a = (#{ a = Int64_u.of_int i; b = Float_u.of_int i } : ur1); b = (#{ a = Int64_u.of_int i } : ur3) } : ur4) in
  (* 1. Create an array of size [size] *)
  let a : ur4 array = makearray_dynamic size (Sys.opaque_identity (#{ a = (#{ a = #0L; b = #0. } : ur1); b = (#{ a = #0L } : ur3) } : ur4)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 135;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity (#{ a = (#{ a = #0L; b = #0. } : ur1); b = (#{ a = #0L } : ur3) } : ur4)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 138;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity (#{ a = (#{ a = #0L; b = #0. } : ur1); b = (#{ a = #0L } : ur3) } : ur4) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity (#{ a = (#{ a = #0L; b = #0. } : ur1); b = (#{ a = #0L } : ur3) } : ur4)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = #(Float_u.of_int i, Int32_u.of_int i, Int64_u.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(float# * int32# * int64#) array = makearray_dynamic size (Sys.opaque_identity #(#0., #0l, #0L)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 143;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #(#0., #0l, #0L)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 146;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #(#0., #0l, #0L) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #(#0., #0l, #0L)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = #(Float_u.of_int i, #(Int64_u.of_int i, Int64_u.of_int i), Float32_u.of_int i, #(Int32_u.of_int i, #(Float32_u.of_int i, Float_u.of_int i)), Int64_u.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(float# * #(int64# * int64#) * float32# * #(int32# * #(float32# * float#)) * int64#) array = makearray_dynamic size (Sys.opaque_identity #(#0., #(#0L, #0L), #0.s, #(#0l, #(#0.s, #0.)), #0L)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 151;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #(#0., #(#0L, #0L), #0.s, #(#0l, #(#0.s, #0.)), #0L)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 154;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #(#0., #(#0L, #0L), #0.s, #(#0l, #(#0.s, #0.)), #0L) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #(#0., #(#0L, #0L), #0.s, #(#0l, #(#0.s, #0.)), #0L)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = #(Int64_u.of_int i, (#{ a = Int64_u.of_int i; b = Float_u.of_int i } : ur1)) in
  (* 1. Create an array of size [size] *)
  let a : #(int64# * ur1) array = makearray_dynamic size (Sys.opaque_identity #(#0L, (#{ a = #0L; b = #0. } : ur1))) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 159;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #(#0L, (#{ a = #0L; b = #0. } : ur1))) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 162;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #(#0L, (#{ a = #0L; b = #0. } : ur1)) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #(#0L, (#{ a = #0L; b = #0. } : ur1))) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = i in
  (* 1. Create an array of size [size] *)
  let a : int array = makearray_dynamic size (Sys.opaque_identity 0) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 207;
  ...
  let mk_value i = (match Int.rem i 3 with 0 -> A3_0 | 1 -> A3_1 | 2 -> A3_2 | _ -> assert false) in
  (* 1. Create an array of size [size] *)
  let a : enum3 array = makearray_dynamic size (Sys.opaque_identity A3_0) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 215;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity A3_0) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 218;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity A3_0 )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity A3_0) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = (#{ a = Int64_u.of_int i; b = i } : ur2) in
  (* 1. Create an array of size [size] *)
  let a : ur2 array = makearray_dynamic size (Sys.opaque_identity (#{ a = #0L; b = 0 } : ur2)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 223;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity (#{ a = #0L; b = 0 } : ur2)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 226;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity (#{ a = #0L; b = 0 } : ur2) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity (#{ a = #0L; b = 0 } : ur2)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = #(i, Int64.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(int * int64) array = makearray_dynamic size (Sys.opaque_identity #(0, 0L)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 231;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #(0, 0L)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 234;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #(0, 0L) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #(0, 0L)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = #((if i == 0 then None else Some (Int64.of_int i)), #(i, Int32.of_int i, Float.of_int i), Float.of_int i, #(Float32.of_int i, (if i == 0 then None else Some ((Nativeint.of_int i, Nativeint.of_int i)))), Int32.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(int64 option * #(int * int32 * float) * float * #(float32 * (nativeint * nativeint) option) * int32) array = makearray_dynamic size (Sys.opaque_identity #(None, #(0, 0l, 0.), 0., #(0.s, None), 0l)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 239;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #(None, #(0, 0l, 0.), 0., #(0.s, None), 0l)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 242;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #(None, #(0, 0l, 0.), 0., #(0.s, None), 0l) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #(None, #(0, 0l, 0.), 0., #(0.s, None), 0l)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = #(Float.of_int i, Float.of_int i, Float.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(float * float * float) array = makearray_dynamic size (Sys.opaque_identity #(0., 0., 0.)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 247;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #(0., 0., 0.)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 250;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #(0., 0., 0.) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #(0., 0., 0.)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = #(Float.of_int i, #(Float.of_int i, Float.of_int i), #(Float.of_int i, #(Float.of_int i, Float.of_int i, Float.of_int i))) in
  (* 1. Create an array of size [size] *)
  let a : #(float * #(float * float) * #(float * #(float * float * float))) array = makearray_dynamic size (Sys.opaque_identity #(0., #(0., 0.), #(0., #(0., 0., 0.)))) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 255;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #(0., #(0., 0.), #(0., #(0., 0., 0.)))) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 258;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #(0., #(0., 0.), #(0., #(0., 0., 0.))) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #(0., #(0., 0.), #(0., #(0., 0., 0.)))) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = #(Float_u.of_int i, i, Int64_u.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(float# * int * int64#) array = makearray_dynamic size (Sys.opaque_identity #(#0., 0, #0L)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 263;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #(#0., 0, #0L)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 266;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #(#0., 0, #0L) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #(#0., 0, #0L)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = #(Float_u.of_int i, #(i, Int64_u.of_int i), Float32_u.of_int i, #(Int32_u.of_int i, #(Float32_u.of_int i, Float_u.of_int i)), i) in
  (* 1. Create an array of size [size] *)
  let a : #(float# * #(int * int64#) * float32# * #(int32# * #(float32# * float#)) * int) array = makearray_dynamic size (Sys.opaque_identity #(#0., #(0, #0L), #0.s, #(#0l, #(#0.s, #0.)), 0)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 271;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #(#0., #(0, #0L), #0.s, #(#0l, #(#0.s, #0.)), 0)) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 274;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #(#0., #(0, #0L), #0.s, #(#0l, #(#0.s, #0.)), 0) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #(#0., #(0, #0L), #0.s, #(#0l, #(#0.s, #0.)), 0)) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  let mk_value i = #((#{ a = Int64_u.of_int i; b = i } : ur2), (#{ a = Int64_u.of_int i; b = Float_u.of_int i } : ur1)) in
  (* 1. Create an array of size [size] *)
  let a : #(ur2 * ur1) array = makearray_dynamic size (Sys.opaque_identity #((#{ a = #0L; b = 0 } : ur2), (#{ a = #0L; b = #0. } : ur1))) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 279;
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (Sys.opaque_identity #((#{ a = #0L; b = 0 } : ur2), (#{ a = #0L; b = #0. } : ur1))) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 282;
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (Sys.opaque_identity #((#{ a = #0L; b = 0 } : ur2), (#{ a = #0L; b = #0. } : ur1)) )in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (Sys.opaque_identity #((#{ a = #0L; b = 0 } : ur2), (#{ a = #0L; b = #0. } : ur1))) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
...
let test_makearray_dynamic_local size =
  ...
  let mk_value i = Float32_u.of_int i in
  (* 1. Create an array of size [size] *)
  let a : float32# array = makearray_dynamic_local size (Sys.opaque_identity #0.s) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 287;
  ...
  let mk_value i = Float_u.of_int i in
  (* 1. Create an array of size [size] *)
  let a : float# array = makearray_dynamic_local size (Sys.opaque_identity #0.) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 295;
  ...
  let mk_value i = Int32_u.of_int i in
  (* 1. Create an array of size [size] *)
  let a : int32# array = makearray_dynamic_local size (Sys.opaque_identity #0l) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 303;
  ...
  let mk_value i = Int64_u.of_int i in
  (* 1. Create an array of size [size] *)
  let a : int64# array = makearray_dynamic_local size (Sys.opaque_identity #0L) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 311;
  ...
  let mk_value i = Nativeint_u.of_int i in
  (* 1. Create an array of size [size] *)
  let a : nativeint# array = makearray_dynamic_local size (Sys.opaque_identity #0n) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 319;
  ...
  let mk_value i = (#{ a = Int64_u.of_int i; b = Float_u.of_int i } : ur1) in
  (* 1. Create an array of size [size] *)
  let a : ur1 array = makearray_dynamic_local size (Sys.opaque_identity (#{ a = #0L; b = #0. } : ur1)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 327;
  ...
  let mk_value i = (#{ a = Int64_u.of_int i } : ur3) in
  (* 1. Create an array of size [size] *)
  let a : ur3 array = makearray_dynamic_local size (Sys.opaque_identity (#{ a = #0L } : ur3)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 335;
  ...
  let mk_value i = (#{ a = (#{ a = Int64_u.of_int i; b = Float_u.of_int i } : ur1); b = (#{ a = Int64_u.of_int i } : ur3) } : ur4) in
  (* 1. Create an array of size [size] *)
  let a : ur4 array = makearray_dynamic_local size (Sys.opaque_identity (#{ a = (#{ a = #0L; b = #0. } : ur1); b = (#{ a = #0L } : ur3) } : ur4)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 343;
  ...
  let mk_value i = #(Float_u.of_int i, Int32_u.of_int i, Int64_u.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(float# * int32# * int64#) array = makearray_dynamic_local size (Sys.opaque_identity #(#0., #0l, #0L)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 351;
  ...
  let mk_value i = #(Float_u.of_int i, #(Int64_u.of_int i, Int64_u.of_int i), Float32_u.of_int i, #(Int32_u.of_int i, #(Float32_u.of_int i, Float_u.of_int i)), Int64_u.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(float# * #(int64# * int64#) * float32# * #(int32# * #(float32# * float#)) * int64#) array = makearray_dynamic_local size (Sys.opaque_identity #(#0., #(#0L, #0L), #0.s, #(#0l, #(#0.s, #0.)), #0L)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 359;
  ...
  let mk_value i = #(Int64_u.of_int i, (#{ a = Int64_u.of_int i; b = Float_u.of_int i } : ur1)) in
  (* 1. Create an array of size [size] *)
  let a : #(int64# * ur1) array = makearray_dynamic_local size (Sys.opaque_identity #(#0L, (#{ a = #0L; b = #0. } : ur1))) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 367;
  ...
  let mk_value i = i in
  (* 1. Create an array of size [size] *)
  let a : int array = makearray_dynamic_local size (Sys.opaque_identity 0) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 415;
  ...
  let mk_value i = (match Int.rem i 3 with 0 -> A3_0 | 1 -> A3_1 | 2 -> A3_2 | _ -> assert false) in
  (* 1. Create an array of size [size] *)
  let a : enum3 array = makearray_dynamic_local size (Sys.opaque_identity A3_0) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 423;
  ...
  let mk_value i = (#{ a = Int64_u.of_int i; b = i } : ur2) in
  (* 1. Create an array of size [size] *)
  let a : ur2 array = makearray_dynamic_local size (Sys.opaque_identity (#{ a = #0L; b = 0 } : ur2)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 431;
  ...
  let mk_value i = #(i, Int64.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(int * int64) array = makearray_dynamic_local size (Sys.opaque_identity #(0, 0L)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 439;
  ...
  let mk_value i = #((if i == 0 then None else Some (Int64.of_int i)), #(i, Int32.of_int i, Float.of_int i), Float.of_int i, #(Float32.of_int i, (if i == 0 then None else Some ((Nativeint.of_int i, Nativeint.of_int i)))), Int32.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(int64 option * #(int * int32 * float) * float * #(float32 * (nativeint * nativeint) option) * int32) array = makearray_dynamic_local size (Sys.opaque_identity #(None, #(0, 0l, 0.), 0., #(0.s, None), 0l)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 447;
  ...
  let mk_value i = #(Float.of_int i, Float.of_int i, Float.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(float * float * float) array = makearray_dynamic_local size (Sys.opaque_identity #(0., 0., 0.)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 455;
  ...
  let mk_value i = #(Float.of_int i, #(Float.of_int i, Float.of_int i), #(Float.of_int i, #(Float.of_int i, Float.of_int i, Float.of_int i))) in
  (* 1. Create an array of size [size] *)
  let a : #(float * #(float * float) * #(float * #(float * float * float))) array = makearray_dynamic_local size (Sys.opaque_identity #(0., #(0., 0.), #(0., #(0., 0., 0.)))) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 463;
  ...
  let mk_value i = #(Float_u.of_int i, i, Int64_u.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(float# * int * int64#) array = makearray_dynamic_local size (Sys.opaque_identity #(#0., 0, #0L)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 471;
  ...
  let mk_value i = #(Float_u.of_int i, #(i, Int64_u.of_int i), Float32_u.of_int i, #(Int32_u.of_int i, #(Float32_u.of_int i, Float_u.of_int i)), i) in
  (* 1. Create an array of size [size] *)
  let a : #(float# * #(int * int64#) * float32# * #(int32# * #(float32# * float#)) * int) array = makearray_dynamic_local size (Sys.opaque_identity #(#0., #(0, #0L), #0.s, #(#0l, #(#0.s, #0.)), 0)) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 479;
  ...
  let mk_value i = #((#{ a = Int64_u.of_int i; b = i } : ur2), (#{ a = Int64_u.of_int i; b = Float_u.of_int i } : ur1)) in
  (* 1. Create an array of size [size] *)
  let a : #(ur2 * ur1) array = makearray_dynamic_local size (Sys.opaque_identity #((#{ a = #0L; b = 0 } : ur2), (#{ a = #0L; b = #0. } : ur1))) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 487;
