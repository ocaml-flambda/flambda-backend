...
let () =
  ...
  let _ : ur4 = (#{ a = (#{ a = 0; b = #0L } : ur2); b = (#{ a = #0L } : ur3) } : ur4) in
  let _ : float32 = 0.s in
  let _ : int32 = 0l in
  let _ : int64 = 0L in
  let _ : nativeint = 0n in
  ...
  let _ : #(int64 option * int32 * #(int32 * float) * float) = #(None, 0l, #(0l, 0.), 0.) in
  ...
  let mk_value i = (#{ a = (#{ a = i; b = Int64_u.of_int i } : ur2); b = (#{ a = Int64_u.of_int i } : ur3) } : ur4) in
  mark_test_run 22;
  let test = eq (mk_value 1) (#{ a = (#{ a = 1; b = #1L } : ur2); b = (#{ a = #1L } : ur3) } : ur4) in
  if not test then failwithf "test 22 failed";
  mark_test_run 23;
  let test = eq (#{ a = (#{ a = 1; b = #1L } : ur2); b = (#{ a = #1L } : ur3) } : ur4) (#{ a = (#{ a = 1; b = #1L } : ur2); b = (#{ a = #1L } : ur3) } : ur4) in
  if not test then failwithf "test 23 failed";
  mark_test_run 24;
  let test = not (eq (#{ a = (#{ a = 1; b = #1L } : ur2); b = (#{ a = #1L } : ur3) } : ur4) (#{ a = (#{ a = 2; b = #2L } : ur2); b = (#{ a = #2L } : ur3) } : ur4)) in
  ...
  let mk_value i = #((if i == 0 then None else Some (Int64.of_int i)), Int32.of_int i, #(Int32.of_int i, Float.of_int i), Float.of_int i) in
  mark_test_run 55;
  let test = eq (mk_value 1) #(Some 1L, 1l, #(1l, 1.), 1.) in
  if not test then failwithf "test 55 failed";
  mark_test_run 56;
  let test = eq #(Some 1L, 1l, #(1l, 1.), 1.) #(Some 1L, 1l, #(1l, 1.), 1.) in
  if not test then failwithf "test 56 failed";
  mark_test_run 57;
  let test = not (eq #(Some 1L, 1l, #(1l, 1.), 1.) #(Some 2L, 2l, #(2l, 2.), 2.)) in
...
let test_makearray_dynamic size =
  ...
  Gc.compact ();
  (* 6. Array contents were unaffected by setting bad indices *)
  for i = 0 to size - 1 do
    mark_test_run 70;
    let test = eq (get a i) (mk_value i) in
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          if not test then failwithf "test 71 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 81;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 81 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 83;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 83 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 91;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 91 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 92;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 92 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 101;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 101 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 103;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 103 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 111;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 111 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 112;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 112 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 131;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 131 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 132;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 132 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
  ...
  let mk_value i = (#{ a = (#{ a = i; b = Int64_u.of_int i } : ur2); b = (#{ a = Int64_u.of_int i } : ur3) } : ur4) in
  (* 1. Create an array of size [size] *)
  let a : ur4 array = makearray_dynamic size (#{ a = (#{ a = 0; b = #0L } : ur2); b = (#{ a = #0L } : ur3) } : ur4) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 134;
    let test = eq el (#{ a = (#{ a = 0; b = #0L } : ur2); b = (#{ a = #0L } : ur3) } : ur4) in
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i (#{ a = (#{ a = 0; b = #0L } : ur2); b = (#{ a = #0L } : ur3) } : ur4) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 139;
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 141;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 141 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 (#{ a = (#{ a = 0; b = #0L } : ur2); b = (#{ a = #0L } : ur3) } : ur4) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 (#{ a = (#{ a = 0; b = #0L } : ur2); b = (#{ a = #0L } : ur3) } : ur4) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
            ...
            mark_test_run 143;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 143 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 151;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 151 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 152;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 152 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 153;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 153 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 161;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 161 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 162;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 162 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 163;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 163 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 171;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 171 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 172;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 172 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 181;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 181 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 183;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 183 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 191;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 191 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 192;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 192 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 193;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 193 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 201;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 201 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 202;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 202 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 203;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 203 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 211;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 211 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 212;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 212 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 221;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 221 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 223;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 223 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 231;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 231 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 232;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 232 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 233;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 233 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
  ...
  let mk_value i = #((if i == 0 then None else Some (Int64.of_int i)), Int32.of_int i, #(Int32.of_int i, Float.of_int i), Float.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(int64 option * int32 * #(int32 * float) * float) array = makearray_dynamic size #(None, 0l, #(0l, 0.), 0.) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 244;
    let test = eq el #(None, 0l, #(0l, 0.), 0.) in
  ...
  iter (bad_indices size) ~f:(fun i ->
    ...
    (* 5. Setting bad indices errors *)
    let raises =
      match set a i #(None, 0l, #(0l, 0.), 0.) with
      | exception Invalid_argument _ -> true
      | _ -> false
    in
    mark_test_run 249;
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 251;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 251 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let a2 = makearray_dynamic size2 #(None, 0l, #(0l, 0.), 0.) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
            ...
            mark_test_run 252;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 252 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
  ...
  iter (sizes) ~f:(fun size2 ->
    iter (blit_offsets size) ~f:(fun ofs1 ->
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          let local_ a2 = makearray_dynamic_local size2 #(None, 0l, #(0l, 0.), 0.) in
          unsafe_blit a ofs1 a2 ofs2 len;
          for i = 0 to size2 - 1 do
            let expected_src_i =
              if i >= ofs2 && i < ofs2 + len then i - ofs2 + ofs1 else 0
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 261;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 261 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 263;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 263 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 271;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 271 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 272;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 272 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 273;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 273 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
...
let test_makearray_dynamic_local size =
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 291;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 291 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 292;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 292 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 301;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 301 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 303;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 303 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 311;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 311 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 312;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 312 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 313;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 313 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 331;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 331 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 332;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 332 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 341;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 341 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 343;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 343 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
  ...
  let mk_value i = (#{ a = (#{ a = i; b = Int64_u.of_int i } : ur2); b = (#{ a = Int64_u.of_int i } : ur3) } : ur4) in
  (* 1. Create an array of size [size] *)
  let a : ur4 array = makearray_dynamic_local size (#{ a = (#{ a = 0; b = #0L } : ur2); b = (#{ a = #0L } : ur3) } : ur4) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 344;
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 351;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 351 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 352;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 352 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 353;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 353 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 361;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 361 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 362;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 362 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 363;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 363 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 371;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 371 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 372;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 372 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 381;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 381 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 383;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 383 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 391;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 391 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 392;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 392 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 393;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 393 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 401;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 401 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 402;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 402 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 403;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 403 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 411;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 411 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 412;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 412 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 421;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 421 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 431;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 431 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 433;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 433 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 441;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 441 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 442;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 442 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 443;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 443 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 451;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 451 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 452;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 452 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
  ...
  let mk_value i = #((if i == 0 then None else Some (Int64.of_int i)), Int32.of_int i, #(Int32.of_int i, Float.of_int i), Float.of_int i) in
  (* 1. Create an array of size [size] *)
  let a : #(int64 option * int32 * #(int32 * float) * float) array = makearray_dynamic_local size #(None, 0l, #(0l, 0.), 0.) in
  (* 2. For initialized arrays, check all elements have the correct value *)
  for i = 0 to size - 1 do
    let el = get a i in
    mark_test_run 454;
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 461;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 461 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 463;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 463 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 471;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 471 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 472;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 472 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 473;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 473 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
    ...
    iter (blit_offsets size) ~f:(fun ofs2 ->
      iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2:size) ~f:(fun len ->
        ...
        for i = 0 to size - 1 do
          ...
          mark_test_run 481;
          let test = eq (get a i) (mk_value expected_src_i) in
          if not test then failwithf "test 481 failed %d %d %d %d %d" size ofs1 ofs2 len i;
        done;
        (* Reset array *)
        for i = 0 to size - 1 do
          set a i (mk_value i);
      ...
      iter (blit_offsets size2) ~f:(fun ofs2 ->
        iter (blit_lens ~ofs1 ~ofs2 ~size1:size ~size2) ~f:(fun len ->
          ...
          for i = 0 to size2 - 1 do
            ...
            mark_test_run 483;
            let test = eq (get a2 i) (mk_value expected_src_i) in
            if not test then failwithf "test 483 failed %d %d %d %d %d %d" size size2 ofs1 ofs2 len i;
          done;
        ) [@nontail];
      ) [@nontail];
    ) [@nontail];
