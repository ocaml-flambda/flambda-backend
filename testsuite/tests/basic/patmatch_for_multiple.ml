...
(let (*match*/282 =[int] 3 *match*/283 =[int] 2 *match*/284 =[int] 1)
  (catch
    (catch
      (catch (if (%noteq *match*/283 3) (exit 3) (exit 1)) with (3)
        (if (%noteq *match*/282 1) (exit 2) (exit 1)))
     with (2) 0)
   with (1) 1))
(let (*match*/282 =[int] 3 *match*/283 =[int] 2 *match*/284 =[int] 1)
  (catch
    (if (%noteq *match*/283 3) (if (%noteq *match*/282 1) 0 (exit 1))
      (exit 1))
   with (1) 1))
- : bool = false
|}];;
...
(let (*match*/287 =[int] 3 *match*/288 =[int] 2 *match*/289 =[int] 1)
  (catch
    (if (%noteq *match*/288 3)
      (if (%noteq *match*/287 1) 0
        (exit 4 (makeblock 0 *match*/287 *match*/288 *match*/289)))
      (exit 4 (makeblock 0 *match*/287 *match*/288 *match*/289)))
   with (4 x/285[(consts ()) (non_consts ([0: [int], [int], [int]]))])
    (seq (ignore x/285) 1)))
- : bool = false
