...
6 |   open M  (* this open shadows label 'x' *)
      ^^^^^^
Warning 44 [open-shadow-identifier]: this open statement shadows the unboxed_label identifier x (which is later used)
...
Error: This expression has type "M.t" but an expression was expected of type
         "('a : value)"
       The layout of M.t is value & value
         because of the definition of t at line 1, characters 18-48.
