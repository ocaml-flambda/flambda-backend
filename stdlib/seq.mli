...
val fold_left : ('acc : value_or_null) ('a : value_or_null). ('acc -> 'a -> 'acc) -> 'acc -> 'a t -> 'acc
...
val fold_lefti : ('acc : value_or_null) ('a : value_or_null). ('acc -> int -> 'a -> 'acc) -> 'acc -> 'a t -> 'acc
...
val find_map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b option) -> 'a t -> 'b option
...
val find_mapi : ('a : value_or_null) ('b : value_or_null). (int -> 'a -> 'b option) -> 'a t -> 'b option
...
val iter2 : ('a : value_or_null) ('b : value_or_null). ('a -> 'b -> unit) -> 'a t -> 'b t -> unit
...
val fold_left2 : ('acc : value_or_null) ('a : value_or_null) ('b : value_or_null). ('acc -> 'a -> 'b -> 'acc) -> 'acc -> 'a t -> 'b t -> 'acc
...
val for_all2 : ('a : value_or_null) ('b : value_or_null). ('a -> 'b -> bool) -> 'a t -> 'b t -> bool
...
val exists2 : ('a : value_or_null) ('b : value_or_null). ('a -> 'b -> bool) -> 'a t -> 'b t -> bool
...
val equal : ('a : value_or_null) ('b : value_or_null). ('a -> 'b -> bool) -> 'a t -> 'b t -> bool
...
val compare : ('a : value_or_null) ('b : value_or_null). ('a -> 'b -> int) -> 'a t -> 'b t -> int
...
val unfold : ('a : value_or_null) ('b : value_or_null). ('b -> ('a * 'b) option) -> 'b -> 'a t
...
val map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b) -> 'a t -> 'b t
...
val mapi : ('a : value_or_null) ('b : value_or_null). (int -> 'a -> 'b) -> 'a t -> 'b t
...
val filter_map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b option) -> 'a t -> 'b t
...
val scan : ('a : value_or_null) ('b : value_or_null). ('b -> 'a -> 'b) -> 'b -> 'a t -> 'b t
...
val flat_map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b t) -> 'a t -> 'b t
(** [flat_map f xs] is equivalent to [concat (map f xs)]. *)

val concat_map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b t) -> 'a t -> 'b t
...
val map2 : ('a : value_or_null) ('b : value_or_null) ('c : value_or_null). ('a -> 'b -> 'c) -> 'a t -> 'b t -> 'c t
...
val sorted_merge : ('a : value_or_null). ('a -> 'a -> int) -> 'a t -> 'a t -> 'a t
...
val product : ('a : value_or_null) ('b : value_or_null). 'a t -> 'b t -> ('a * 'b) t
...
val map_product : ('a : value_or_null) ('b : value_or_null) ('c : value_or_null). ('a -> 'b -> 'c) -> 'a t -> 'b t -> 'c t
...
val split : ('a : value_or_null) ('b : value_or_null). ('a * 'b) t -> 'a t * 'b t
(** [split] is an alias for [unzip].

    @since 4.14 *)

val partition_map : ('a : value_or_null) ('b : value_or_null) ('c : value_or_null). ('a -> ('b, 'c) Either.t) -> 'a t -> 'b t * 'c t
