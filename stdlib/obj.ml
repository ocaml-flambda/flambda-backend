...
external magic_portable_with : 'a -> 'a @ portable @@ portable = "%identity"
external magic_uncontended : 'a @ contended -> 'a @@ portable = "%identity"
external magic_uncontended_cocontended : 'a @ contended -> 'a @@ portable = "%identity"
external magic_uncontended_move : 'a @ contended -> 'a @@ portable = "%identity"
external magic_uncontended_borrow : 'a @ contended -> 'a @@ portable = "%identity"
