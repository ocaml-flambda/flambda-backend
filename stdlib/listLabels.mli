...
val compare_lengths : ('a : value_or_null) ('b : value_or_null). 'a list -> 'b list -> int
...
val equal : ('a : value_or_null). eq:('a -> 'a -> bool) -> 'a list -> 'a list -> bool
...
val compare : ('a : value_or_null). cmp:('a -> 'a -> int) -> 'a list -> 'a list -> int
...
val map : ('a : value_or_null) ('b : value_or_null). f:('a -> 'b) -> 'a list -> 'b list
(** [map ~f [a1; ...; an]] applies function [f] to [a1, ..., an],
   and builds the list [[f a1; ...; f an]]
   with the results returned by [f].
 *)

val mapi : ('a : value_or_null) ('b : value_or_null). f:(int -> 'a -> 'b) -> 'a list -> 'b list
...
val rev_map : ('a : value_or_null) ('b : value_or_null). f:('a -> 'b) -> 'a list -> 'b list
(** [rev_map ~f l] gives the same result as
   {!rev}[ (]{!map}[ f l)], but is more efficient.
 *)

val filter_map : ('a : value_or_null) ('b : value_or_null). f:('a -> 'b option) -> 'a list -> 'b list
...
val concat_map : ('a : value_or_null) ('b : value_or_null). f:('a -> 'b list) -> 'a list -> 'b list
...
val fold_left_map :
  ('acc : value_or_null) ('a : value_or_null) ('b : value_or_null). f:('acc -> 'a -> 'acc * 'b) -> init:'acc -> 'a list -> 'acc * 'b list
(** [fold_left_map] is  a combination of [fold_left] and [map] that threads an
    accumulator through calls to [f].
    @since 4.11
*)

val fold_left : ('acc : value_or_null) ('a : value_or_null). f:('acc -> 'a -> 'acc) -> init:'acc -> 'a list -> 'acc
(** [fold_left ~f ~init [b1; ...; bn]] is
   [f (... (f (f init b1) b2) ...) bn].
 *)

val fold_right : ('a : value_or_null) ('acc : value_or_null). f:('a -> 'acc -> 'acc) -> 'a list -> init:'acc -> 'acc
...
val iter2 : ('a : value_or_null) ('b : value_or_null). f:('a -> 'b -> unit) -> 'a list -> 'b list -> unit
...
val map2 : ('a : value_or_null) ('b : value_or_null) ('c : value_or_null). f:('a -> 'b -> 'c) -> 'a list -> 'b list -> 'c list
...
val rev_map2 : ('a : value_or_null) ('b : value_or_null) ('c : value_or_null). f:('a -> 'b -> 'c) -> 'a list -> 'b list -> 'c list
(** [rev_map2 ~f l1 l2] gives the same result as
   {!rev}[ (]{!map2}[ f l1 l2)], but is more efficient.
 *)

val fold_left2 :
  ('acc : value_or_null) ('a : value_or_null) ('b : value_or_null). f:('acc -> 'a -> 'b -> 'acc) -> init:'acc -> 'a list -> 'b list -> 'acc
...
val fold_right2 :
  ('a : value_or_null) ('b : value_or_null) ('acc : value_or_null). f:('a -> 'b -> 'acc -> 'acc) -> 'a list -> 'b list -> init:'acc -> 'acc
...
val for_all2 : ('a : value_or_null) ('b : value_or_null). f:('a -> 'b -> bool) -> 'a list -> 'b list -> bool
(** Same as {!for_all}, but for a two-argument predicate.
   @raise Invalid_argument if the two lists are determined
   to have different lengths.
 *)

val exists2 : ('a : value_or_null) ('b : value_or_null). f:('a -> 'b -> bool) -> 'a list -> 'b list -> bool
...
val find_map : ('a : value_or_null) ('b : value_or_null). f:('a -> 'b option) -> 'a list -> 'b option
...
val find_mapi : ('a : value_or_null) ('b : value_or_null). f:(int -> 'a -> 'b option) -> 'a list -> 'b option
...
val partition : ('a : value_or_null). f:('a -> bool) -> 'a list -> 'a list * 'a list
...
val partition_map : ('a : value_or_null) ('b : value_or_null) ('c : value_or_null). f:('a -> ('b, 'c) Either.t) -> 'a list -> 'b list * 'c list
...
val assoc : ('a : value_or_null) ('b : value_or_null). 'a -> ('a * 'b) list -> 'b
...
val assoc_opt : ('a : value_or_null) ('b : value_or_null). 'a -> ('a * 'b) list -> 'b option
...
val assq_opt : ('a : value_or_null) ('b : value_or_null). 'a -> ('a * 'b) list -> 'b option
(** Same as {!assoc_opt}, but uses physical equality instead of
   structural equality to compare keys.
   @since 4.05
 *)

val mem_assoc : ('a : value_or_null) ('b : value_or_null). 'a -> map:('a * 'b) list -> bool
(** Same as {!assoc}, but simply return [true] if a binding exists,
   and [false] if no bindings exist for the given key.
 *)

val mem_assq : ('a : value_or_null) ('b : value_or_null). 'a -> map:('a * 'b) list -> bool
(** Same as {!mem_assoc}, but uses physical equality instead of
   structural equality to compare keys.
 *)

val remove_assoc : ('a : value_or_null) ('b : value_or_null). 'a -> ('a * 'b) list -> ('a * 'b) list
(** [remove_assoc a l] returns the list of
   pairs [l] without the first pair with key [a], if any.
   Not tail-recursive.
 *)

val remove_assq : ('a : value_or_null) ('b : value_or_null). 'a -> ('a * 'b) list -> ('a * 'b) list
...
val split : ('a : value_or_null) ('b : value_or_null). ('a * 'b) list -> 'a list * 'b list
(** Transform a list of pairs into a pair of lists:
   [split [(a1,b1); ...; (an,bn)]] is [([a1; ...; an], [b1; ...; bn])].
   Not tail-recursive.
 *)

val combine : ('a : value_or_null) ('b : value_or_null). 'a list -> 'b list -> ('a * 'b) list
...
val stable_sort : ('a : value_or_null). cmp:('a -> 'a -> int) -> 'a list -> 'a list
...
val fast_sort : ('a : value_or_null). cmp:('a -> 'a -> int) -> 'a list -> 'a list
(** Same as {!sort} or {!stable_sort}, whichever is
    faster on typical input.
 *)

val sort_uniq : ('a : value_or_null). cmp:('a -> 'a -> int) -> 'a list -> 'a list
(** Same as {!sort}, but also remove duplicates.
    @since 4.02 (4.03 in ListLabels)
 *)

val merge : ('a : value_or_null). cmp:('a -> 'a -> int) -> 'a list -> 'a list -> 'a list
(** Merge two lists:
