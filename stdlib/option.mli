...
val bind : ('a : value_or_null) ('b : value_or_null). 'a option -> ('a -> 'b option) -> 'b option
(** [bind o f] is [f v] if [o] is [Some v] and [None] if [o] is [None]. *)

val join : ('a : value_or_null). 'a option option -> 'a option
(** [join oo] is [Some v] if [oo] is [Some (Some v)] and [None] otherwise. *)

val map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b) -> 'a option -> 'b option
(** [map f o] is [None] if [o] is [None] and [Some (f v)] if [o] is [Some v]. *)

val fold : ('a : value_or_null) ('b : value_or_null). none:'a -> some:('b -> 'a) -> 'b option -> 'a
...
val to_result : ('a : value_or_null) ('e : value_or_null). none:'e -> 'a option -> ('a, 'e) result
