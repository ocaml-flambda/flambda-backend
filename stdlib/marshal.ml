...
external to_channel: ('a : value_or_null) . out_channel -> 'a -> extern_flags list -> unit @@ portable
    = "caml_output_value"
external to_bytes: ('a : value_or_null) . 'a -> extern_flags list -> bytes @@ portable
    = "caml_output_value_to_bytes"
external to_string: ('a : value_or_null) . 'a -> extern_flags list -> string @@ portable
    = "caml_output_value_to_string"
external to_buffer_unsafe:
      ('a : value_or_null) . bytes -> int -> int -> 'a -> extern_flags list -> int @@ portable
...
external from_channel: ('a : value_or_null) . in_channel -> 'a @@ portable = "caml_input_value"
external from_bytes_unsafe: ('a : value_or_null) . bytes -> int -> 'a @@ portable = "caml_input_value_from_bytes"
external data_size_unsafe: ('a : value_or_null) . bytes -> int -> int @@ portable = "caml_marshal_data_size"
