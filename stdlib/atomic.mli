...
external compare_and_set : ('a : value_or_null)
  . 'a t -> 'a -> 'a -> bool @@ nonportable = "%atomic_cas"
...
external compare_exchange : ('a : value_or_null)
  . 'a t -> 'a -> 'a -> 'a @@ nonportable = "%atomic_compare_exchange"
...
module Safe : sig @@ portable
  ...
  *)
  external set : ('a : value_or_null)
    . 'a t -> 'a @ portable contended -> unit = "%atomic_set"
  ...
  *)
  external compare_and_set :
    ('a : value_or_null)
    . 'a t -> 'a @ portable contended -> 'a @ portable contended 
    -> bool = "%atomic_cas"
  ...
  external compare_exchange :
    ('a : value_or_null)
    . 'a t -> 'a @ portable contended -> 'a @ portable contended 
    -> 'a @ portable contended = "%atomic_compare_exchange"
end
