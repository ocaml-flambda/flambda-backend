  ...
  { minor_heap_size : int;
    ...
    (** This value controls the GC messages on standard error output.
       ...
       on the corresponding events:
        ...
        - [0x00004] Per-slice events and computations.
        - [0x00008] Heap compaction.
        - [0x00010] Computation of compaction-triggering condition.
        ...
        - [0x00400] Resizing of stacks and GC tables.
        - [0x00800] Output GC statistics at program exit.
        - [0x01000] Rare stack overflow conditions.
