...
let table_count = Atomic.Safe.make 0
...
let method_count = Atomic.Safe.make 0
let inst_var_count = Atomic.Safe.make 0
...
let stats () =
  { classes = Atomic.Safe.get table_count;
    methods = Atomic.Safe.get method_count; inst_vars = Atomic.Safe.get inst_var_count; }
