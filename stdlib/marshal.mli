...
val to_channel : ('a : value_or_null) . out_channel -> 'a -> extern_flags list -> unit
...
external to_bytes :
  ('a : value_or_null) . 'a -> extern_flags list -> bytes = "caml_output_value_to_bytes"
...
external to_string :
  ('a : value_or_null) . 'a -> extern_flags list -> string = "caml_output_value_to_string"
(** Same as [to_bytes] but return the result as a string instead of
    a byte sequence. *)

val to_buffer : ('a : value_or_null) . bytes -> int -> int -> 'a -> extern_flags list -> int
...
val from_channel : ('a : value_or_null) . in_channel -> 'a
...
val from_bytes : ('a : value_or_null) . bytes -> int -> 'a
...
val from_string : ('a : value_or_null) . string -> int -> 'a
