...
val left : ('a : value_or_null) ('b : value_or_null). 'a -> ('a, 'b) t
(** [left v] is [Left v]. *)

val right : ('a : value_or_null) ('b : value_or_null). 'b -> ('a, 'b) t
(** [right v] is [Right v]. *)

val is_left : ('a : value_or_null) ('b : value_or_null). ('a, 'b) t -> bool
(** [is_left (Left v)] is [true], [is_left (Right v)] is [false]. *)

val is_right : ('a : value_or_null) ('b : value_or_null). ('a, 'b) t -> bool
(** [is_right (Left v)] is [false], [is_right (Right v)] is [true]. *)

val find_left : ('a : value_or_null) ('b : value_or_null). ('a, 'b) t -> 'a option
(** [find_left (Left v)] is [Some v], [find_left (Right _)] is [None] *)

val find_right : ('a : value_or_null) ('b : value_or_null). ('a, 'b) t -> 'b option
(** [find_right (Right v)] is [Some v], [find_right (Left _)] is [None] *)

val map_left : ('a1 : value_or_null) ('a2 : value_or_null) ('b : value_or_null). 
  ('a1 -> 'a2) -> ('a1, 'b) t -> ('a2, 'b) t
(** [map_left f e] is [Left (f v)] if [e] is [Left v]
    and [e] if [e] is [Right _]. *)

val map_right : ('a : value_or_null) ('b1 : value_or_null) ('b2 : value_or_null).
  ('b1 -> 'b2) -> ('a, 'b1) t -> ('a, 'b2) t
(** [map_right f e] is [Right (f v)] if [e] is [Right v]
    and [e] if [e] is [Left _]. *)

val map : ('a1 : value_or_null) ('a2 : value_or_null) ('b1 : value_or_null) ('b2 : value_or_null).
