...
val equal : ('a : value_or_null). ('a -> 'a -> bool) -> 'a list -> 'a list -> bool
...
val compare : ('a : value_or_null). ('a -> 'a -> int) -> 'a list -> 'a list -> int
...
val map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b) -> 'a list -> 'b list
(** [map f [a1; ...; an]] applies function [f] to [a1, ..., an],
   and builds the list [[f a1; ...; f an]]
   with the results returned by [f].
 *)

val mapi : ('a : value_or_null) ('b : value_or_null). (int -> 'a -> 'b) -> 'a list -> 'b list
...
val rev_map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b) -> 'a list -> 'b list
(** [rev_map f l] gives the same result as
   {!rev}[ (]{!map}[ f l)], but is more efficient.
 *)

val filter_map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b option) -> 'a list -> 'b list
...
val concat_map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b list) -> 'a list -> 'b list
...
val iter2 : ('a : value_or_null) ('b : value_or_null). ('a -> 'b -> unit) -> 'a list -> 'b list -> unit
...
val map2 : ('a : value_or_null) ('b : value_or_null) ('c : value_or_null). ('a -> 'b -> 'c) -> 'a list -> 'b list -> 'c list
...
val rev_map2 : ('a : value_or_null) ('b : value_or_null) ('c : value_or_null). ('a -> 'b -> 'c) -> 'a list -> 'b list -> 'c list
...
val for_all2 : ('a : value_or_null) ('b : value_or_null). ('a -> 'b -> bool) -> 'a list -> 'b list -> bool
(** Same as {!for_all}, but for a two-argument predicate.
   @raise Invalid_argument if the two lists are determined
   to have different lengths.
 *)

val exists2 : ('a : value_or_null) ('b : value_or_null). ('a -> 'b -> bool) -> 'a list -> 'b list -> bool
...
val find_map : ('a : value_or_null) ('b : value_or_null). ('a -> 'b option) -> 'a list -> 'b option
...
val find_mapi : ('a : value_or_null) ('b : value_or_null). (int -> 'a -> 'b option) -> 'a list -> 'b option
...
val partition : ('a : value_or_null). ('a -> bool) -> 'a list -> 'a list * 'a list
...
val partition_map : ('a : value_or_null) ('b : value_or_null) ('c : value_or_null). ('a -> ('b, 'c) Either.t) -> 'a list -> 'b list * 'c list
...
val mem_assoc : ('a : value_or_null) ('b : value_or_null). 'a -> ('a * 'b) list -> bool
(** Same as {!assoc}, but simply return [true] if a binding exists,
   and [false] if no bindings exist for the given key.
 *)

val mem_assq : ('a : value_or_null) ('b : value_or_null). 'a -> ('a * 'b) list -> bool
...
val merge : ('a : value_or_null). ('a -> 'a -> int) -> 'a list -> 'a list -> 'a list
(** Merge two lists:
