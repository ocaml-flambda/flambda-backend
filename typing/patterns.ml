...
module Simple = struct
  type view = [
    ...
    | `Record_flat of
        (Longident.t loc * label_flat_description * pattern) list * closed_flag
...
module Head : sig
  type desc =
    ...
    | Record_flat of label_flat_description list
    | Variant of
