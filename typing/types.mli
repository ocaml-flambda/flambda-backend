...
and record_unboxed_product_representation =
  ...
  (* We treat all unboxed products as the same "representation" as any differences in
     their layout are encapsulated by the jkinds tracked in the labels. We keep this
     variant for uniformity with boxed records, and to make it easier to support different
