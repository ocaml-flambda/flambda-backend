...
val extension_descr:
  current_unit:Compilation_unit.with_kind option ->
...
val constructors_of_type:
  current_unit:Compilation_unit.with_kind option -> Path.t ->
  type_declaration -> (Ident.t * constructor_description) list
