...
let descriptions = [
  ...
  { number = 73;
    ...
    since = since 5 1 };
  { number = 74;
    names = ["unmutated-mut-var"];
    description =
    "Suspicious mutable variable was never mutated: mutable variable that is\n\
...
let message = function
  ...
  | Unmutated_mut_var v -> "mutable variable " ^ v ^ " was never mutated."
