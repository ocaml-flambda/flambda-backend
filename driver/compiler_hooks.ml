...
type _ pass =
  ...
  | Cleaned_flambda2 : Flambda2_terms.Flambda_unit.t pass
...
type t = {
  ...
  mutable cleaned_flambda2 : (Flambda2_terms.Flambda_unit.t -> unit) list;
...
let register : type a. a pass -> (a -> unit) -> unit =
  ...
  | Cleaned_flambda2 -> hooks.cleaned_flambda2 <- f :: hooks.cleaned_flambda2
...
let execute : type a. a pass -> a -> unit =
  ...
  | Cleaned_flambda2 -> execute_hooks hooks.cleaned_flambda2 arg
...
let clear : type a. a pass -> unit =
  ...
  | Cleaned_flambda2 -> hooks.cleaned_flambda2 <- []
