...
let cfg_regalloc = ref ""               (* -cfg-regalloc *)
let cfg_regalloc_params = ref ([] : string list)  (* -cfg-regalloc-param *)
let cfg_regalloc_validate = ref true    (* -[no-]cfg-regalloc-validate *)
