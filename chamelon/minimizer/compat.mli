...
val mkTarrow : Asttypes.arg_label * type_expr * type_expr * commutable -> type_desc
...
val mkTexp_ident : Path.t * Longident.t Location.loc * value_description -> expression_desc
val mkTexp_apply : expression * (Asttypes.arg_label * apply_arg) list -> expression_desc
val mkTexp_tuple : expression list -> expression_desc
val mkTexp_construct :
  Longident.t Location.loc * constructor_description * expression list -> expression_desc
val mkTexp_function : texp_function -> expression_desc
val mkTexp_sequence : expression * expression -> expression_desc
val mkTexp_match : expression * computation case list * partial -> expression_desc
...
val mk_value_binding :
  vb_pat:value general_pattern -> vb_expr:expression -> vb_attributes:attributes -> value_binding
