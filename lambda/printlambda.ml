...
let primitive ppf = function
  ...
  | Patomic_fetch_land -> fprintf ppf "atomic_fetch_land"
  | Patomic_fetch_lor -> fprintf ppf "atomic_fetch_lor"
  | Patomic_fetch_lxor -> fprintf ppf "atomic_fetch_lxor"
...
let name_of_primitive = function
  ...
  | Patomic_fetch_land -> "Patomic_fetch_land"
  | Patomic_fetch_lor -> "Patomic_fetch_lor"
  | Patomic_fetch_lxor -> "Patomic_fetch_lxor"
  | Popaque _ -> "Popaque"
  | Prunstack -> "Prunstack"
  | Presume -> "Presume"
  | Pperform -> "Pperform"
