...
module Lambda_utils = struct
  module Constants = struct
    ...
    let unboxed_int8 i = Lconst (Const_base (Const_unboxed_int8 i))

    let unboxed_int16 i = Lconst (Const_base (Const_unboxed_int16 i))
  ...
  module Primitive = struct
    ...
    let make_unboxed_int8_vect = unary "caml_make_unboxed_int8_vect"

    let make_unboxed_int16_vect = unary "caml_make_unboxed_int16_vect"
