...
let fmt_constant f x =
  ...
  | Pconst_integer {naked; value; suffix} ->
    fprintf f "PConst_int (%a,%s,%s)" fmt_naked_flag naked value suffix
  | Pconst_char (naked, c) ->
    fprintf f "PConst_char (%a,%02x)" fmt_naked_flag naked (Char.code c)
  ...
  | Pconst_float {naked; value; suffix }->
    fprintf f "PConst_float (%a,%s,%s)" fmt_naked_flag naked value suffix
;;
