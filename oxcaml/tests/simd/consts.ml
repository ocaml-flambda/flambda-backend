...
module Float32x4 = struct
  ...
  external const4 : float32 -> float32 -> float32 -> float32 -> t
...
module Int32x4 = struct
  ...
  external const4 : int32 -> int32 -> int32 -> int32 -> t
    = "" "caml_int32x4_const4"
    [@@noalloc] [@@unboxed] [@@builtin]
...
module Int8x16 = struct
  ...
  let () =
    ...
    check16 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff
      0xff 0xff 0xff;
    check16 0x80 0x80 0x80 0x80 0x80 0x80 0x80 0x80 0x80 0x80 0x80 0x80 0x80
      0x80 0x80 0x80;
