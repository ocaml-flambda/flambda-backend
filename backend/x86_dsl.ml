...
module I = struct
  ...
  let vfmaddsd o x y z = emit (VFMADDSD (o, x, y, z))
  let vfnmaddsd o x y z = emit (VFNMADDSD (o, x, y, z))
  let vfmsubsd o x y z = emit (VFMSUBSD (o, x, y, z))
  let vfnmsubsd o x y z = emit (VFNMSUBSD (o, x, y, z))
