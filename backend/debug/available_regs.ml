    ...
    | Ok avail_before -> (
      ...
      | Iop
          (( Icall_ind | Icall_imm _ | Ialloc _ | Ipoll _ | Iprobe _
           ...
           | Ivectorcast _ | Iscalarcast _ | Ivalueofint | Iintofvalue | Iopaque
           | Ispecific _ | Iprobe_is_enabled _ | Ibeginregion | Iendregion ) as
          op) ->
        ...
        let made_unavailable_2 =
          ...
          | Iintop_imm _ | Iintop_atomic _ | Icompf _ | Inegf | Iabsf | Iaddf
          | Isubf | Imulf | Idivf | Icsel _ | Ifloatofint | Iintoffloat
          | Ivalueofint | Iintofvalue | Iscalarcast _ | Ivectorcast _ | Iopaque
