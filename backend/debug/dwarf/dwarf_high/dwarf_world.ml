...
let emit ~params ~compilation_unit_proto_die ~start_of_code_symbol
  ...
  Profile.record "dwarf_world_emit" (fun () ->
      ...
      Profile.record "aranges_table"
        (Aranges_table.emit ~params) aranges_table;
