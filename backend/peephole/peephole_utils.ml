...
(* CR-soon gtulba-lecu for gtulba-lecu: make sure that this comparison is correct and
   sufficent. *)
let are_equal_regs (reg1 : Reg.t) (reg2 : Reg.t) =
  Reg.same_loc reg1 reg2 && reg1.typ = reg2.typ

(* CR-soon gtulba-lecu for gtulba-lecu: Delete this when imeplementing auto-generated
   rules. *)
let go_back_const = 1
