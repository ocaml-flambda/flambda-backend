...
val cache_string : string -> Dwarf_misc.cmm_label
...
(** Define a label at the current position in the current section.
    ...
    [define_symbol], above. *)
val define_label : Dwarf_misc.cmm_label -> unit

(** Emit a machine-width reference to the given label. *)
val label : Dwarf_misc.cmm_label -> unit
...
val between_labels_32bit : upper:Dwarf_misc.cmm_label -> lower:Dwarf_misc.cmm_label -> unit
...
val label_for_section : section -> Dwarf_misc.cmm_label
...
val string_of_label : Dwarf_misc.cmm_label -> string