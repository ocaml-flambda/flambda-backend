...
val log_substitution : indent:int -> Regalloc_substitution.t -> unit

val log_substitutions : indent:int -> Regalloc_substitution.map -> unit

val log_stack_subst : indent:int -> Regalloc_substitution.t -> unit
