 ...
 fun cell ->
  ...
  | Some cell -> (
    ...
    | Op
        ...
        | Intop _ | Intop_imm _ | Intop_atomic _ | Negf _ | Absf _ | Addf _
        | Subf _ | Mulf _ | Divf _ | Compf _ | Csel _ | Valueofint | Intofvalue
  ...
  let rec loop (allocations : allocation list) (cell : cell option)
    ...
    | Some cell -> (
      ...
      | Reloadretaddr | Poptrap | Prologue | Pushtrap _ ->
        ...
        { allocations = List.rev allocations; next_cell = Some cell }
      | Op
          ( Move | Spill | Reload | Negf _ | Absf _ | Addf _ | Subf _ | Mulf _
          | Divf _ | Valueofint | Intofvalue | Vectorcast _ | Opaque
