...
module Move : sig
  ...
  val make_instr : t -> id:Instruction.id -> copy:_ Cfg.instruction -> from:Reg.t -> to_:Reg.t -> Instruction.t
...
val make_temporary : same_class_and_base_name_as:Reg.t -> name_prefix:string -> Reg.t
